...
x0 = opt.Z0;
old = load('res/initial_guess'); x0 = old.x;
...
%%
N = size(outputs{1}.q, 1);
M = 5;

alphas1 = bezfit(linspace(0,1,N), outputs{1}.q(:, [7:9, 12:14])', M);
alphas2 = bezfit(linspace(0,1,N), outputs{2}.q(:, [7:9, 12:14])', M);

alphas1b = reshape(outputs{1}.a(1, :), [6, 6])';
alphas2b = reshape(outputs{2}.a(1, :), [6, 6])';
