...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	if(nlhs!=13) mexErrMsgTxt("MEX function ATRIAS3D_Positions_Hip expects 13 output arguments.");
	if(nrhs!=2) mexErrMsgTxt("MEX function ATRIAS3D_Positions_Hip expects 2 input arguments.");
	...
	/* Invoke function */
	ATRIAS3D_Positions_Hip(q, extra_vars, pcm, p0, p0T, pHR, p1R, p2R, p3R, p4R, pHL, p1L, p2L, p3L, p4L) ;
}
