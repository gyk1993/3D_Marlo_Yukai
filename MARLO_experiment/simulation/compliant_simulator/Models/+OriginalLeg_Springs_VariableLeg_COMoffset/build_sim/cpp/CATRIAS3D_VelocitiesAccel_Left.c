/* ATRIAS3D_VELOCITIESACCEL_LEFT 
 * Generated by writeOptimizedFunctions (17 Oct 2016 14:01:45)
 */

#include <mex.h>
#include "ATRIAS3D_VelocitiesAccel_Left.h"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	if(nlhs!=7) mexErrMsgTxt("MEX function ATRIAS3D_VelocitiesAccel_Left expects 7 output arguments.");
	if(nrhs!=3) mexErrMsgTxt("MEX function ATRIAS3D_VelocitiesAccel_Left expects 3 input arguments.");
	...
	/* Invoke function */
	ATRIAS3D_VelocitiesAccel_Left(q, dq, extra_vars, vcm, *J_cm, *dJ_cm, v0T, vHL, vHR, v0) ;
}
