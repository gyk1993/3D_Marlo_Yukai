/* ATRIAS3D_POSITIONS_RIGHT 
 * Generated by writeOptimizedFunctions (17 Oct 2016 14:01:36)
 */

#include <mex.h>
#include "ATRIAS3D_Positions_Right.h"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	if(nlhs!=13) mexErrMsgTxt("MEX function ATRIAS3D_Positions_Right expects 13 output arguments.");
	if(nrhs!=2) mexErrMsgTxt("MEX function ATRIAS3D_Positions_Right expects 2 input arguments.");
	...
	/* Invoke function */
	ATRIAS3D_Positions_Right(q, extra_vars, pcm, p0, p0T, pHR, p1R, p2R, p3R, p4R, pHL, p1L, p2L, p3L, p4L) ;
}
