function [AbsAngle, IncAngle, Rollover, IncCalTick] = calibrateEncoders_ATRIAS(Calibration,AbsEncoders,IncEncoders,IncEncodersPrev,Reset,RolloverIn,IncCalTickIn)
    %#codegen
