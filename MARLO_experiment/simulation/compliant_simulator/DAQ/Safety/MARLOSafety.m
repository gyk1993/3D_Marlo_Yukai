function [MotorCurrentCommandSafe, MedullaCommandSafe, IMUCommandSafe, SafetyState, SafetyCountOut] = MARLOSafety(MotorCurrentCommand, MedullaCommand, IMUCommand, q, dq, Switches, Thermistors, LogicVoltage, SafetyCountIn, RequestSoftStop, SelectBasicLimits, FaultDetected)
    %#codegen
    ...
    if (SafetyCountOut < 4) && (RequestSoftStop == 0) && (max(FaultDetected) == 0)
