function [MotorCurrentCommandSafe, MedullaCommandSafe, IMUCommandSafe, SafetyState, SafetyCountOut,violation] = MARLOSafety_System_ID(MotorCurrentCommand, MedullaCommand, IMUCommand, q, dq, Switches, Thermistors, LogicVoltage, SafetyCountIn)
    %#codegen
...
%     SS_INVALID_MEDULLA_COMMAND = 2^41; % bit 42
        SS_INVALID_MOTOR_COMMAND   = 0; % bit 41
    SS_INVALID_MEDULLA_COMMAND = 0; % bit 42
    ...
    SafetyState2 = ones(34,1).*violation
