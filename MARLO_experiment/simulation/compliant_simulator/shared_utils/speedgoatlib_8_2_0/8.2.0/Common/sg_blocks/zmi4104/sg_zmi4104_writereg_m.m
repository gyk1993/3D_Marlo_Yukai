function slot = sg_zmi4104_writereg_m(id, zmi_id, axis, pci_access)
    ...
    if (pci_access == 1)
    maskDisplay = [maskDisplay, 'port_label(''input'',3,''Value (16-bit)'');'];
    elseif (pci_access == 2)
    maskDisplay = [maskDisplay, 'port_label(''input'',3,''Value (32-bit)'');'];
    end
    ...
    maskDescription = 'Speedgoat driver block<br>ZMI4104 - Write register<br><br>&copy; 2006 - 2012, Speedgoat GmbH, www.speedgoat.ch';
