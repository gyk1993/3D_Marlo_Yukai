...
#define 	S_FUNCTION_NAME 	sg_IO750_setup_s
...
static void mdlStart(SimStruct *S)
{
    ...
    {  
        ...
        printf("EtherCAT Slave\n");
        
        strcpy(cardData.driveletter, drive);
        strcpy(cardData.firmware, FIRMWARE_ECS);    // EtherCAT Slave
        ...
        else
        {
            ...
            ecsData.input = input;
            ecsData.output = output;
            
            sg_cifx_ecs_data(cardId, SG_DATA_WRITE, &ecsData);
        }
