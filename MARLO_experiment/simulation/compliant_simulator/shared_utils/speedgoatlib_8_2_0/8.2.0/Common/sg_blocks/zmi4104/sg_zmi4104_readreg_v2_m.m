function slot = sg_zmi4104_readreg_v2_m(id)
    ...
    maskDisplay = [maskDisplay, 'port_label(''output'',1,''Value'');'];  
    
    set_param(gcb, 'MaskDisplay', maskDisplay);
    
    maskDescription = 'Speedgoat driver block<br>ZMI4104 - Read register<br><br>&copy; 2006 - 2013, Speedgoat GmbH, www.speedgoat.ch';
