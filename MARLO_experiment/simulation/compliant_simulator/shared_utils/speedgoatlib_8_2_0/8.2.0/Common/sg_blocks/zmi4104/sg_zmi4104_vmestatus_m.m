function slot = sg_zmi4104_vmestatus_m(id)
    ...
    maskDisplay = [maskDisplay, 'port_label(''output'',1,''Fiber-optic'');'];

    
    set_param(gcb, 'MaskDisplay', maskDisplay);
    
    maskDescription = 'Speedgoat driver block<br>ZMI4104 - VME Status<br><br>&copy; 2006 - 2012, Speedgoat GmbH, www.speedgoat.ch';
