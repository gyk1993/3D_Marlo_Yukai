function board = xpcIO304_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO304 IntA';
 board.VendorId = hex2dec('16d5'); 
 board.DeviceId = hex2dec('504'); 
 board.SubVendorId = hex2dec('16d5');
 board.SubDeviceId = hex2dec('504');
 board.PreHookFunction = 'xpcIO304intaprehook';
 board.PostHookFunction =  'NULL'; 
 board.HookIncludeFile = 'xpcIO304intahooks';
 board.StartFunction = 'xpcIO304intastart';
 board.StopFunction = 'xpcIO304intastop';
