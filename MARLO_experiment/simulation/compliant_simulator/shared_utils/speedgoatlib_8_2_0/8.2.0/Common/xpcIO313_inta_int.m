function board = xpcIO313_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO313 IntA';
 board.VendorId = hex2dec('16d5'); 
 board.DeviceId = hex2dec('4353'); 
 board.SubVendorId = hex2dec('16d5');
 board.SubDeviceId = hex2dec('4353');
 board.PreHookFunction = 'xpcIO313intaprehook';
 board.PostHookFunction =  'NULL';
 board.HookIncludeFile = 'xpcIO313intahooks';
 board.StartFunction = 'xpcIO313intastart';
 board.StopFunction = 'xpcIO313intastop';
