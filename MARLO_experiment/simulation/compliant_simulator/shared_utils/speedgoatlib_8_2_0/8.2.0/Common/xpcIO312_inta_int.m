function board = xpcIO312_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO312 IntA';
 board.VendorId = hex2dec('16d5'); 
 board.DeviceId = hex2dec('424B'); 
 board.SubVendorId = hex2dec('16d5');
 board.SubDeviceId = hex2dec('424B');
 board.PreHookFunction = 'xpcIO312intaprehook';
 board.PostHookFunction =  'NULL'; %'xpcdx2004intaposthook'
 board.HookIncludeFile = 'xpcIO312intahooks';
 board.StartFunction = 'xpcIO312intastart';
 board.StopFunction = 'xpcIO312intastop';
