#ifndef __XPCIO304INTAHOOKS_C__
#define __XPCDIO304INTAHOOKS_C__
...
int __cdecl xpcIO304intaprehook(xpcPCIDevice *pci);
void __cdecl xpcIO304intastart(xpcPCIDevice *pci);
void __cdecl xpcIO304intastop(xpcPCIDevice *pci);
