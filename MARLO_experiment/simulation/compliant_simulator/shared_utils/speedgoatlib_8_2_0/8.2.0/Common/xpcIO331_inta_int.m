function board = xpcIO331_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO331 IntA';
 board.VendorId = hex2dec('16d5'); 
 board.DeviceId = hex2dec('5701'); 
 board.SubVendorId = hex2dec('16d5');
 board.SubDeviceId = hex2dec('5701');
 board.PreHookFunction = 'xpcIO331intaprehook';
 board.PostHookFunction =  'NULL';  
 board.HookIncludeFile = 'xpcIO331intahooks';
 board.StartFunction = 'xpcIO331intastart';
 board.StopFunction = 'xpcIO331intastop';
