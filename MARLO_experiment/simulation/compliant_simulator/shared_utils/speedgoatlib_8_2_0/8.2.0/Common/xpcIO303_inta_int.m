function board = xpcIO303_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO303 IntA';
 board.VendorId = hex2dec('16d5'); 
 board.DeviceId = hex2dec('4253'); 
 board.SubVendorId = hex2dec('16d5');
 board.SubDeviceId = hex2dec('4253');
 board.PreHookFunction = 'xpcIO303intaprehook';
 board.PostHookFunction =  'NULL';  %'xpcdx503intaposthook'
 board.HookIncludeFile = 'xpcIO303intahooks';
 board.StartFunction = 'xpcIO303intastart';
 board.StopFunction = 'xpcIO303intastop';
