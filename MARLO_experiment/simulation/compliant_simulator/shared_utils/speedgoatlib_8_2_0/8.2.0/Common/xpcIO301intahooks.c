#ifndef __XPCIO301INTAHOOKS_C__
#define __XPCIO301INTAHOOKS_C__
...
int __cdecl xpcIO301intaprehook(xpcPCIDevice *pci);
void __cdecl xpcIO301intastart(xpcPCIDevice *pci);
void __cdecl xpcIO301intastop(xpcPCIDevice *pci);
