function board = xpcIO511_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO511 IntA';
 board.VendorId = hex2dec('10B5'); 
 board.DeviceId = hex2dec('9080'); 
 board.SubVendorId = hex2dec('10B5');
 board.SubDeviceId = hex2dec('2401');
 board.PreHookFunction = 'xpcIO511intaprehook';
 board.PostHookFunction = 'NULL';
 board.HookIncludeFile = 'xpcIO511intahooks';
 board.StartFunction = 'xpcIO511intastart';
 board.StopFunction = 'xpcIO511intastop';
