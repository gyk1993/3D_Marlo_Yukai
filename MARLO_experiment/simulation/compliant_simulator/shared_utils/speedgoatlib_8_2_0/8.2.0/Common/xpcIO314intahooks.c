#ifndef __XPCIO314INTAHOOKS_C__
#define __XPCIO314INTAHOOKS_C__
...
int __cdecl xpcIO314intaprehook(xpcPCIDevice *pci);
void __cdecl xpcIO314intastart(xpcPCIDevice *pci);
void __cdecl xpcIO314intastop(xpcPCIDevice *pci);
