#ifndef __XPCIO303INTAHOOKS_C__
#define __XPCIO303INTAHOOKS_C__
...
int __cdecl xpcIO303intaprehook(xpcPCIDevice *pci);
void __cdecl xpcIO303intastart(xpcPCIDevice *pci);
void __cdecl xpcdx503intastop(xpcPCIDevice *pci);
...
void __cdecl xpcIO303intastop(xpcPCIDevice *pci)
{
  volatile struct plxInt *plx;  
  volatile struct SYNCH *synch;
