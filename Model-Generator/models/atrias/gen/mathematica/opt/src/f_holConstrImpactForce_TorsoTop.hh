...
namespace symbolic_expression
{
  namespace basic
  {
    ...
    inline void f_holConstrImpactForce_TorsoTop(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var)
    {
      // Check
      // - Inputs
      ...
      f_holConstrImpactForce_TorsoTop_raw(p_output1.data(), var.data());
    }
