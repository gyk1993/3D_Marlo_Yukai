...
namespace symbolic_expression
{
  namespace basic
  {
    ...
    inline void Js_holConstrVelocity_RightFoot(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var)
    {
      // Check
      // - Inputs
      ...
      Js_holConstrVelocity_RightFoot_raw(p_output1.data(), var.data());
    }
