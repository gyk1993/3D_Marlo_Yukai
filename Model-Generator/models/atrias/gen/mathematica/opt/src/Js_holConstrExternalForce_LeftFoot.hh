...
namespace symbolic_expression
{
  namespace basic
  {
    ...
    inline void Js_holConstrExternalForce_LeftFoot(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var)
    {
      // Check
      // - Inputs
      ...
      Js_holConstrExternalForce_LeftFoot_raw(p_output1.data(), var.data());
    }
