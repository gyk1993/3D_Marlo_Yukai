...
namespace symbolic_expression
{
  namespace basic
  {
    ...
    inline void Js_holConstrAcceleration_TorsoTop(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var)
    {
      // Check
      // - Inputs
      ...
      Js_holConstrAcceleration_TorsoTop_raw(p_output1.data(), var.data());
    }
