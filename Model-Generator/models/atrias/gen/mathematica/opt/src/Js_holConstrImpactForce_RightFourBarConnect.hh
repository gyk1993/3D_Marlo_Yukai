...
namespace symbolic_expression
{
  namespace basic
  {
    ...
    inline void Js_holConstrImpactForce_RightFourBarConnect(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var)
    {
      // Check
      // - Inputs
      ...
      Js_holConstrImpactForce_RightFourBarConnect_raw(p_output1.data(), var.data());
    }
