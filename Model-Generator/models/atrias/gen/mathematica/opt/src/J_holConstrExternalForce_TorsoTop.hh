...
namespace symbolic_expression
{
  namespace basic
  {
    ...
    inline void J_holConstrExternalForce_TorsoTop(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var)
    {
      // Check
      // - Inputs
      ...
      J_holConstrExternalForce_TorsoTop_raw(p_output1.data(), var.data());
    }
