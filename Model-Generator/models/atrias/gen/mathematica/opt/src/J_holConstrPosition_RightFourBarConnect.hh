...
namespace symbolic_expression
{
  namespace basic
  {
    ...
    inline void J_holConstrPosition_RightFourBarConnect(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var)
    {
      // Check
      // - Inputs
      ...
      J_holConstrPosition_RightFourBarConnect_raw(p_output1.data(), var.data());
    }
