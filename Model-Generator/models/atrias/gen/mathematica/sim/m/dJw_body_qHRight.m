function [x_dJw_body_qHRight] = dJw_body_qHRight(x)
%dJw_body_qHRight
%    x_dJw_body_qHRight = dJw_body_qHRight(x)
...
t128=t13.*t15.*t2.*t8;
t129=t11.*t14.*t19.*t2;
x_dJw_body_qHRight=[0,0,0,0,0,0,0,0,0,t52.*t73 + t64.*t82 + t34.*((-1).*t6.*t7 + (-1) ...
  ...
  t119.*t13.*t15.*t8 + 2.*t12.*t120.*t13.*t6.*t9,0,2.*t112.*t118 +  ...
  2.*t55.*t61 + 2.*t85.*t91,t100.*(t126 + (-1).*t14.*t18) + t103.*( ...
  t127 + t128 + t129 + (-1).*t13.*t18.*t19 + (-1).*t14.*t46) + (-1) ...
  .*t11.*t12.*t125.*t6 + t52.*((-1).*t14.*t22 + t11.*t13.*t7) +  ...
  t64.*(t10.*t11.*t13.*t2 + (-1).*t13.*t19.*t22 + (-1).*t14.*t30 + ( ...
  -1).*t11.*t14.*t19.*t7 + (-1).*t13.*t15.*t7.*t8) + t125.*t15.*t8.* ...
  t9 + (-1).*t11.*t9.*((-1).*t11.*t13.*t15 + (-1).*t11.*t13.*t19.* ...
  t6 + t14.*t19.*t8 + t14.*t15.*t6.*t8 + t11.*t12.*t14.*t9),0,0,0,0, ...
