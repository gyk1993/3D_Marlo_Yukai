function [x_Jp_qARight] = Jp_qARight(x)
%Jp_qARight
%    x_Jp_qARight = Jp_qARight(x)
...
t14=t10.*t3;
t15=t13 + t14;
x_Jp_qARight=[1,0,0,0,1,0,0,0,1,0,(1831/10000).*(t11.*t12.*t3 + t6.*((-1).* ...
  ...
  t10.*t3.*t9),(1831/10000).*((-1).*t11.*t12.*t7 + (-1).*t6.*t9),( ...
  1831/10000).*((-1).*t12.*t15 + t11.*t6.*t8),(1831/10000).*((-1).* ...
  t11.*t3.*t6 + (-1).*t12.*(t10.*t8 + (-1).*t3.*t7.*t9)),0,0,0,0,0, ...
