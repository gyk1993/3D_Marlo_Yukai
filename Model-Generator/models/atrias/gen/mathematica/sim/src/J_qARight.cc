...
static void output1(double *p_output1,const double *x)
{
  ...
  p_output1[18]=0.1831*(-1.*t10*t6*t7 - 1.*t11*t9);
  p_output1[19]=0.1831*(-1.*t15*t7 + t6*t8*t9);
  p_output1[20]=0.1831*(-1.*t7*(-1.*t10*t11*t3 + t12*t8) - 1.*t3*t6*t9);
}
...
void J_qARight_raw(double *p_output1, const double *x)
{
  // Call Subroutines
  output1(p_output1, x);
