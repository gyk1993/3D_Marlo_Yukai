...
static void output1(double *p_output1,const double *x)
{
  ...
  p_output1[18]=t12*t30*t45 + t12*t54*t66 + t12*t75*t78;
  p_output1[19]=t11*Power(t45,2) + t11*Power(t66,2) + t11*Power(t78,2);
  p_output1[20]=t42*(-1.*t15*t22 + t13*t14*t5) + (-1.*t15*t27 + t34)*t72 + (-1.*t14*t15*t7 - 1.*t13*t8)*t84;
  p_output1[24]=Power(t30,2) + Power(t54,2) + Power(t75,2);
  p_output1[25]=(-1.*t11*t18 - 1.*t12*t24)*t45 + (-1.*t11*t48 - 1.*t12*t51)*t66 + (t10*t11*t14 - 1.*t12*t69)*t78;
}
...
void Jw_body_qBRight_raw(double *p_output1, const double *x)
{
  // Call Subroutines
  output1(p_output1, x);
