...
static void output1(double *p_output1,const double *x)
{
  ...
  p_output1[34]=2.*t112*t118 + 2.*t55*t70 + 2.*t85*t91;
  p_output1[35]=t103*(t124 - 1.*t14*t18) - 1.*t11*t12*t123*t6 + t52*(-1.*t14*t22 + t11*t13*t7) + t58*(-1.*t13*t19*t22 + t10*t11*t13*t3 - 1.*t14*t40 - 1.*t11*t14*t19*t7 - 1.*t13*t15*t7*t8) + t123*t15*t8*t9 - 1.*t11*t9*(-1.*t11*t13*t15 - 1.*t11*t13*t19*t6 + t14*t19*t8 + t14*t15*t6*t8 + t11*t12*t14*t9) + (t125 + t126 + t127 - 1.*t13*t18*t19 - 1.*t14*t31)*t97;
}
...
void dJw_body_qHLeft_raw(double *p_output1, const double *x)
{
  // Call Subroutines
  output1(p_output1, x);
