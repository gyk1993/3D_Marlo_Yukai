...
static void output1(double *p_output1,const double *x)
{
  ...
  p_output1[36]=Power(t30,2) + Power(t54,2) + Power(t75,2);
  p_output1[37]=(-1.*t11*t18 - 1.*t12*t24)*t45 + (-1.*t11*t48 - 1.*t12*t51)*t66 + (t10*t11*t14 - 1.*t12*t69)*t78;
}
...
void Jw_body_qALeft_raw(double *p_output1, const double *x)
{
  // Call Subroutines
  output1(p_output1, x);
