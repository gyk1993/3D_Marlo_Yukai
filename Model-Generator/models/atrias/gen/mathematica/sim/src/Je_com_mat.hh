...
namespace symbolic_expression
{
  namespace basic
  {
    ...
    inline void Je_com_mat(Eigen::MatrixXd &p_output1, Eigen::MatrixXd &p_output2, Eigen::MatrixXd &p_output3, const Eigen::VectorXd &x)
    {
      // Check
      // - Inputs
...
p_output3.setZero();
      ...
      Je_com_mat_raw(p_output1.data(), p_output2.data(), p_output3.data(), x.data());
    }
