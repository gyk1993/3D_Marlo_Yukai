...
static void output1(double *p_output1,const double *x)
{
  ...
  p_output1[18]=0.4*t104*t22*t30 + 0.4*(t104*t18*t26 - 1.*t104*t22*t30) + 0.4*t104*t18*t35 + 0.1831*(-1.*t12*t13*t6 - 1.*t11*t8);
  p_output1[19]=0.4*t107*t22*t30 + 0.4*(t107*t18*t26 - 1.*t107*t22*t30) + 0.4*t107*t18*t35 + 0.1831*(-1.*t13*t38 + t11*t12*t7);
  p_output1[20]=0.1831*(-1.*t111*t13 + t23) + 0.4*t113*t22*t30 + 0.4*(t113*t18*t26 - 1.*t113*t22*t30) + 0.4*t113*t18*t35;
  p_output1[21]=t135 + 0.4*(t139 + t119*t26) + 0.4*t119*t35;
  p_output1[22]=t140 + 0.4*(t141 + t125*t26) + 0.4*t125*t35;
  p_output1[23]=t142 + 0.4*(t143 + t134*t26) + 0.4*t134*t35;
  p_output1[27]=t135 + 0.4*t138*t26 + 0.4*(t139 - 1.*t138*t26);
  p_output1[28]=t140 + 0.4*t26*t50 + 0.4*(t141 - 1.*t26*t50);
  p_output1[29]=t142 + 0.4*t146*t26 + 0.4*(t143 - 1.*t146*t26);
}
...
void J_fourBarARight_raw(double *p_output1, const double *x)
{
  // Call Subroutines
  output1(p_output1, x);
