...
static void output1(double *p_output1,const double *x)
{
  ...
  p_output1[34]=Power(t24,2) + Power(t36,2) + Power(t45,2);
  p_output1[35]=t27*(-1.*t12*t15 + t10*t11*t4) + t39*(-1.*t12*t21 + t46) - 1.*t11*(-1.*t11*t12*t6 - 1.*t10*t7)*t9;
}
...
void Jw_body_qHLeft_raw(double *p_output1, const double *x)
{
  // Call Subroutines
  output1(p_output1, x);
