...
CseWriteMatlab[name_String,expr_,OptionsPattern[]]:=
	...
	oexpr = CseOptimization`CseOptimizeExpression[vexpr,OptimizationLevel->OptionValue[OptimizationLevel]];

	(* Hack to get code to write correctly when there are no optimizations (very simple code) *)
	If[Count[oexpr,_Hold]>0,
		{vars, code} = {oexpr[[1]],oexpr[[2]]};
