function board = xpcIO311_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO311 IntA';
 board.VendorId = hex2dec('16d5'); 
 board.DeviceId = hex2dec('524D'); 
 board.SubVendorId = hex2dec('16d5');
 board.SubDeviceId = hex2dec('524D');
 board.PreHookFunction = 'xpcIO311intaprehook';
 board.PostHookFunction =  'NULL';  
 board.HookIncludeFile = 'xpcIO311intahooks';
 board.StartFunction = 'xpcIO311intastart';
 board.StopFunction = 'xpcIO311intastop';
