#ifndef __XPCIO313INTAHOOKS_C__
#define __XPCIO313INTAHOOKS_C__
...
int __cdecl xpcIO313intaprehook(xpcPCIDevice *pci);
void __cdecl xpcIO313intastart(xpcPCIDevice *pci);
void __cdecl xpcIO313intastop(xpcPCIDevice *pci);
