...
#define         S_FUNCTION_NAME         write_hw_fifo_PMC521_XR17D15x
...
#define HALFDUPLEX_ARG          ssGetSFcnParam(S,3)
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    if ((int32_T)(mxGetPr(HALFDUPLEX_ARG)[0])) {
       
        regtmp = reg->mcr;
        regtmp = regtmp & ~MCRDTR;
        regtmp = regtmp | MCRRTS;
        reg->mcr = regtmp;
    }
