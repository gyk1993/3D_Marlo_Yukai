#ifndef __XPCIO321INTAHOOKS_C__
#define __XPCIO321INTAHOOKS_C__
...
int __cdecl xpcIO321intaprehook(xpcPCIDevice *pci);
void __cdecl xpcIO321intastart(xpcPCIDevice *pci);
void __cdecl xpcIO321intastop(xpcPCIDevice *pci);
