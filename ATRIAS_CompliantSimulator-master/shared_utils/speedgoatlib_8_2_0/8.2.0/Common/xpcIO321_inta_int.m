function board = xpcIO321_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO321 IntA';
 board.VendorId = hex2dec('16d5'); 
 board.DeviceId = hex2dec('4c40'); 
 board.SubVendorId = hex2dec('16d5');
 board.SubDeviceId = hex2dec('4c40');
 board.PreHookFunction = 'xpcIO321intaprehook';
 board.PostHookFunction =  'NULL'; 
 board.HookIncludeFile = 'xpcIO321intahooks';
 board.StartFunction = 'xpcIO321intastart';
 board.StopFunction = 'xpcIO321intastop';
