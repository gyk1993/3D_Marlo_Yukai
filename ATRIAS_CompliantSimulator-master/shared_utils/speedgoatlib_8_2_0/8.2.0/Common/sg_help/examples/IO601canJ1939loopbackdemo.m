%% IO601 CAN J1939 loopback demo
% Simple J1939 loopback demo with the IO601 CAN I/O module, using a DB file.
...
% <matlab:open_system('IO601canJ1939loopback') IO601canJ1939loopback>.

% Open the model
open_system('IO601canJ1939loopback');

% Build the model and download to the target computer
set_param('IO601canJ1939loopback','RTWVerbose','off'); % Configure for non-verbose build
rtwbuild('IO601canJ1939loopback');                     % Build and download application
