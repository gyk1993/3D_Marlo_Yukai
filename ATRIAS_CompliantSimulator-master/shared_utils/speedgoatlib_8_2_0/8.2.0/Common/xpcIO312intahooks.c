#ifndef __XPCIO312INTAHOOKS_C__
#define __XPCIO312INTAHOOKS_C__
...
int __cdecl xpcIO312intaprehook(xpcPCIDevice *pci);
void __cdecl xpcIO312intastart(xpcPCIDevice *pci);
void __cdecl xpcIO312intastop(xpcPCIDevice *pci);
