#ifndef __XPCIO311INTAHOOKS_C__
#define __XPCIO311INTAHOOKS_C__
...
int __cdecl xpcIO311intaprehook(xpcPCIDevice *pci);
void __cdecl xpcIO311intastart(xpcPCIDevice *pci);
void __cdecl xpcIO311intastop(xpcPCIDevice *pci);
