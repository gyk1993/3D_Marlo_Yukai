...
MODEL           = xpcosc
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c xpc_datatype_ground.c xpcosc_capi.c xpcosc_data.c 
MAKEFILE        = xpcosc.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\xingye\Documents\SVN\MARLO_Controllers\DAQ\R2016a\xpcblocks
S_FUNCTIONS     = 
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
...
MODELLIB                  = xpcosclib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = xpcosc_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\xpcosc_slrt_rtw
