...
static void initialize_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct
  *chartInstance);
static void initialize_params_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct
  *chartInstance);
static void enable_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct *chartInstance);
static void disable_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_ATRIAS_test
  (SFc2_ATRIAS_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_ATRIAS_test
  (SFc2_ATRIAS_testInstanceStruct *chartInstance);
static void set_sim_state_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct
  *chartInstance);
static void sf_gateway_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct
  *chartInstance);
static void mdl_start_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct
  *chartInstance);
static void initSimStructsc2_ATRIAS_test(SFc2_ATRIAS_testInstanceStruct
  *chartInstance);
static void c2_M_to_ZYX(SFc2_ATRIAS_testInstanceStruct *chartInstance, real_T
  c2_M[9], real_T c2_EulerAngles[3]);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct *chartInstance,
  const mxArray *c2_b_YawRollover, const char_T *c2_identifier, real_T c2_y[2]);
static void c2_b_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[2]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct *chartInstance,
  const mxArray *c2_b_R0, const char_T *c2_identifier, real_T c2_y[9]);
static void c2_d_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[9]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct *chartInstance,
  const mxArray *c2_b_dZYX, const char_T *c2_identifier, real_T c2_y[3]);
static void c2_f_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct *chartInstance,
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_g_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct
...
static void c2_eml_scalar_eg(SFc2_ATRIAS_testInstanceStruct *chartInstance);
static void c2_threshold(SFc2_ATRIAS_testInstanceStruct *chartInstance);
static void c2_eml_error(SFc2_ATRIAS_testInstanceStruct *chartInstance);
static real_T c2_atan2(SFc2_ATRIAS_testInstanceStruct *chartInstance, real_T
  c2_y, real_T c2_x);
static real_T c2_squeeze(SFc2_ATRIAS_testInstanceStruct *chartInstance, real_T
  c2_a);
static void c2_Rz(SFc2_ATRIAS_testInstanceStruct *chartInstance, real_T c2_t,
                  real_T c2_R[9]);
static real_T c2_getYawRollover(SFc2_ATRIAS_testInstanceStruct *chartInstance,
  real_T c2_CurrentYaw, real_T c2_PreviousYaw);
static void c2_b_eml_scalar_eg(SFc2_ATRIAS_testInstanceStruct *chartInstance);
static void c2_mldivide(SFc2_ATRIAS_testInstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_Y[3]);
static real_T c2_rdivide(SFc2_ATRIAS_testInstanceStruct *chartInstance, real_T
  c2_x, real_T c2_y);
static void c2_eml_warning(SFc2_ATRIAS_testInstanceStruct *chartInstance);
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_h_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_i_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_ATRIAS_test, const char_T
  *c2_identifier);
static uint8_T c2_j_emlrt_marshallIn(SFc2_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_ATRIAS_testInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_ATRIAS_testInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_ATRIAS_test = 0U;
}
  ...
  (SFc2_ATRIAS_testInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_ATRIAS_test;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_ATRIAS_test = c2_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 5)),
     "is_active_c2_ATRIAS_test");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_ATRIAS_test(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_ATRIAS_test(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_ATRIAS_testInstanceStruct *chartInstance;
  chartInstance = (SFc2_ATRIAS_testInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_ATRIAS_test_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_ATRIAS_test), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_ATRIAS_test);
  return c2_y;
}
...
void sf_c2_ATRIAS_test_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_ATRIAS_test_get_post_codegen_info(void);
mxArray *sf_c2_ATRIAS_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_ATRIAS_test_get_post_codegen_info();
...
mxArray *sf_c2_ATRIAS_test_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_ATRIAS_test_jit_fallback_info(void)
{
...
mxArray *sf_c2_ATRIAS_test_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_ATRIAS_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[13],T\"R0\",},{M[1],M[5],T\"Rk\",},{M[1],M[18],T\"YawRollover\",},{M[1],M[10],T\"ZYX\",},{M[1],M[16],T\"dZYX\",},{M[8],M[0],T\"is_active_c2_ATRIAS_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_ATRIAS_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_ATRIAS_testInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_ATRIAS_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_ATRIAS_testInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*)
    chartInstanceVar);
  initialize_c2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_ATRIAS_test(void *chartInstanceVar)
{
  enable_c2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_ATRIAS_test(void *chartInstanceVar)
{
  disable_c2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_ATRIAS_test(void *chartInstanceVar)
{
  sf_gateway_c2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_ATRIAS_test(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_ATRIAS_test(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_ATRIAS_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_ATRIAS_testInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_ATRIAS_test((SFc2_ATRIAS_testInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_ATRIAS_test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_ATRIAS_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_ATRIAS_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_ATRIAS_test(SimStruct *S)
{
  SFc2_ATRIAS_testInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_ATRIAS_testInstanceStruct *)utMalloc(sizeof
    (SFc2_ATRIAS_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_ATRIAS_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_ATRIAS_test;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_ATRIAS_test;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_ATRIAS_test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_ATRIAS_test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_ATRIAS_test;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_ATRIAS_test;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_ATRIAS_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_ATRIAS_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_ATRIAS_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_ATRIAS_test;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_ATRIAS_test;
...
void c2_ATRIAS_test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_ATRIAS_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_ATRIAS_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_ATRIAS_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_ATRIAS_test_method_dispatcher.\n"
