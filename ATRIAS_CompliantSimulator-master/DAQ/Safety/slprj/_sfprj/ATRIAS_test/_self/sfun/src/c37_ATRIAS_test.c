...
static void initialize_c37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
static void initialize_params_c37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
static void enable_c37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
static void disable_c37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
static void c37_update_debugger_state_c37_ATRIAS_test
  (SFc37_ATRIAS_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c37_ATRIAS_test
  (SFc37_ATRIAS_testInstanceStruct *chartInstance);
static void set_sim_state_c37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c37_st);
static void finalize_c37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
static void sf_gateway_c37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
static void mdl_start_c37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
static void initSimStructsc37_ATRIAS_test(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
...
static const mxArray *c37_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_emlrt_marshallIn(SFc37_ATRIAS_testInstanceStruct *chartInstance,
  const mxArray *c37_b_motorVoltage, const char_T *c37_identifier, real_T c37_y
  [6]);
static void c37_b_emlrt_marshallIn(SFc37_ATRIAS_testInstanceStruct
...
static const mxArray *c37_b_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static real_T c37_c_emlrt_marshallIn(SFc37_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
...
static const mxArray *c37_c_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static int32_T c37_d_emlrt_marshallIn(SFc37_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static uint8_T c37_e_emlrt_marshallIn(SFc37_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c37_b_is_active_c37_ATRIAS_test, const char_T
  *c37_identifier);
static uint8_T c37_f_emlrt_marshallIn(SFc37_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void init_dsm_address_info(SFc37_ATRIAS_testInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc37_ATRIAS_testInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c37_is_active_c37_ATRIAS_test = 0U;
}
  ...
  (SFc37_ATRIAS_testInstanceStruct *chartInstance)
{
  ...
  c37_hoistedGlobal = chartInstance->c37_is_active_c37_ATRIAS_test;
  ...
  *chartInstance, const mxArray *c37_st)
{
  ...
  chartInstance->c37_is_active_c37_ATRIAS_test = c37_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c37_u, 1)),
     "is_active_c37_ATRIAS_test");
  sf_mex_destroy(&c37_u);
  c37_update_debugger_state_c37_ATRIAS_test(chartInstance);
  ...
  *c37_inData)
{
  ...
  const mxArray *c37_y = NULL;
  SFc37_ATRIAS_testInstanceStruct *chartInstance;
  chartInstance = (SFc37_ATRIAS_testInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c37_ATRIAS_test_get_eml_resolved_functions_info(void)
{
  ...
  *c37_identifier)
{
  ...
  c37_y = c37_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c37_b_is_active_c37_ATRIAS_test), &c37_thisId);
  sf_mex_destroy(&c37_b_is_active_c37_ATRIAS_test);
  return c37_y;
}
...
void sf_c37_ATRIAS_test_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c37_ATRIAS_test_get_post_codegen_info(void);
mxArray *sf_c37_ATRIAS_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c37_ATRIAS_test_get_post_codegen_info();
...
mxArray *sf_c37_ATRIAS_test_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c37_ATRIAS_test_jit_fallback_info(void)
{
...
mxArray *sf_c37_ATRIAS_test_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c37_ATRIAS_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"motorVoltage\",},{M[8],M[0],T\"is_active_c37_ATRIAS_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c37_ATRIAS_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc37_ATRIAS_testInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c37_ATRIAS_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc37_ATRIAS_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*)
    chartInstanceVar);
  initialize_c37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c37_ATRIAS_test(void *chartInstanceVar)
{
  enable_c37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c37_ATRIAS_test(void *chartInstanceVar)
{
  disable_c37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c37_ATRIAS_test(void *chartInstanceVar)
{
  sf_gateway_c37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c37_ATRIAS_test(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c37_ATRIAS_test(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c37_ATRIAS_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc37_ATRIAS_testInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc37_ATRIAS_test((SFc37_ATRIAS_testInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c37_ATRIAS_test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c37_ATRIAS_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c37_ATRIAS_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c37_ATRIAS_test(SimStruct *S)
{
  SFc37_ATRIAS_testInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc37_ATRIAS_testInstanceStruct *)utMalloc(sizeof
    (SFc37_ATRIAS_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc37_ATRIAS_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c37_ATRIAS_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c37_ATRIAS_test;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c37_ATRIAS_test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c37_ATRIAS_test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c37_ATRIAS_test;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c37_ATRIAS_test;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c37_ATRIAS_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c37_ATRIAS_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c37_ATRIAS_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c37_ATRIAS_test;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c37_ATRIAS_test;
...
void c37_ATRIAS_test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c37_ATRIAS_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c37_ATRIAS_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c37_ATRIAS_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c37_ATRIAS_test_method_dispatcher.\n"
