...
static void initialize_c39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
static void initialize_params_c39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
static void enable_c39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
static void disable_c39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
static void c39_update_debugger_state_c39_ATRIAS_test
  (SFc39_ATRIAS_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c39_ATRIAS_test
  (SFc39_ATRIAS_testInstanceStruct *chartInstance);
static void set_sim_state_c39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c39_st);
static void finalize_c39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
static void sf_gateway_c39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
static void mdl_start_c39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
static void initSimStructsc39_ATRIAS_test(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
static uint32_T c39_EncodeSwitches(SFc39_ATRIAS_testInstanceStruct
...
static const mxArray *c39_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static real_T c39_emlrt_marshallIn(SFc39_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c39_b_LimitSwitchesEncoded, const char_T
  *c39_identifier);
static real_T c39_b_emlrt_marshallIn(SFc39_ATRIAS_testInstanceStruct
...
static const mxArray *c39_c_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static void c39_c_emlrt_marshallIn(SFc39_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId,
  uint32_T c39_y[6]);
...
static const mxArray *c39_d_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static uint32_T c39_d_emlrt_marshallIn(SFc39_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId);
...
static const mxArray *c39_e_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static int32_T c39_e_emlrt_marshallIn(SFc39_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId);
static void c39_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c39_mxArrayInData, const char_T *c39_varName, void *c39_outData);
static uint8_T c39_f_emlrt_marshallIn(SFc39_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c39_b_is_active_c39_ATRIAS_test, const char_T
  *c39_identifier);
static uint8_T c39_g_emlrt_marshallIn(SFc39_ATRIAS_testInstanceStruct
  *chartInstance, const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId);
static void init_dsm_address_info(SFc39_ATRIAS_testInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc39_ATRIAS_testInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c39_is_active_c39_ATRIAS_test = 0U;
}
  ...
  (SFc39_ATRIAS_testInstanceStruct *chartInstance)
{
  ...
  c39_b_hoistedGlobal = chartInstance->c39_is_active_c39_ATRIAS_test;
  ...
  *chartInstance, const mxArray *c39_st)
{
  ...
  *chartInstance->c39_LimitSwitchesEncoded = c39_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c39_is_active_c39_ATRIAS_test = c39_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c39_u, 1)),
     "is_active_c39_ATRIAS_test");
  sf_mex_destroy(&c39_u);
  c39_update_debugger_state_c39_ATRIAS_test(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 8U, chartInstance->c39_sfEvent);
  for (c39_i0 = 0; c39_i0 < 6; c39_i0++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c39_Switches)[c39_i0], 0U);
  }

  chartInstance->c39_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, chartInstance->c39_sfEvent);
  ...
  *chartInstance->c39_LimitSwitchesEncoded = c39_b_LimitSwitchesEncoded;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 8U, chartInstance->c39_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c39_inData)
{
  ...
  const mxArray *c39_y = NULL;
  SFc39_ATRIAS_testInstanceStruct *chartInstance;
  chartInstance = (SFc39_ATRIAS_testInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c39_ATRIAS_test_get_eml_resolved_functions_info(void)
{
  ...
  *c39_identifier)
{
  ...
  c39_y = c39_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c39_b_is_active_c39_ATRIAS_test), &c39_thisId);
  sf_mex_destroy(&c39_b_is_active_c39_ATRIAS_test);
  return c39_y;
}
...
void sf_c39_ATRIAS_test_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c39_ATRIAS_test_get_post_codegen_info(void);
mxArray *sf_c39_ATRIAS_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c39_ATRIAS_test_get_post_codegen_info();
...
mxArray *sf_c39_ATRIAS_test_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c39_ATRIAS_test_jit_fallback_info(void)
{
...
mxArray *sf_c39_ATRIAS_test_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c39_ATRIAS_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"LimitSwitchesEncoded\",},{M[8],M[0],T\"is_active_c39_ATRIAS_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c39_ATRIAS_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc39_ATRIAS_testInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c39_ATRIAS_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc39_ATRIAS_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*)
    chartInstanceVar);
  initialize_c39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c39_ATRIAS_test(void *chartInstanceVar)
{
  enable_c39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c39_ATRIAS_test(void *chartInstanceVar)
{
  disable_c39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c39_ATRIAS_test(void *chartInstanceVar)
{
  sf_gateway_c39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c39_ATRIAS_test(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c39_ATRIAS_test(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c39_ATRIAS_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc39_ATRIAS_testInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc39_ATRIAS_test((SFc39_ATRIAS_testInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c39_ATRIAS_test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c39_ATRIAS_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c39_ATRIAS_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c39_ATRIAS_test(SimStruct *S)
{
  SFc39_ATRIAS_testInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc39_ATRIAS_testInstanceStruct *)utMalloc(sizeof
    (SFc39_ATRIAS_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc39_ATRIAS_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c39_ATRIAS_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c39_ATRIAS_test;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c39_ATRIAS_test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c39_ATRIAS_test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c39_ATRIAS_test;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c39_ATRIAS_test;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c39_ATRIAS_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c39_ATRIAS_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c39_ATRIAS_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c39_ATRIAS_test;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c39_ATRIAS_test;
...
void c39_ATRIAS_test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c39_ATRIAS_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c39_ATRIAS_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c39_ATRIAS_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c39_ATRIAS_test_method_dispatcher.\n"
