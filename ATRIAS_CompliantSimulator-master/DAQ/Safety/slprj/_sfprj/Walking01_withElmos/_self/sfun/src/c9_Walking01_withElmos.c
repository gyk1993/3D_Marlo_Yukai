...
static void initialize_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void initialize_params_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void enable_c9_Walking01_withElmos(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance);
static void disable_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void ext_mode_exec_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void set_sim_state_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c9_st);
static void c9_set_sim_state_side_effects_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void finalize_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void sf_gateway_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void mdl_start_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void initSimStructsc9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void c9_Run(SFc9_Walking01_withElmosInstanceStruct *chartInstance);
static void c9_exit_internal_Run(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static boolean_T c9_emlrt_marshallIn(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static real_T c9_b_emlrt_marshallIn(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c9_nargout, const char_T *c9_identifier);
static real_T c9_c_emlrt_marshallIn(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static boolean_T c9_check_error(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_d_emlrt_marshallIn(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_d_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static uint8_T c9_e_emlrt_marshallIn(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c9_b_is_Run, const char_T *c9_identifier);
static uint8_T c9_f_emlrt_marshallIn(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static const mxArray *c9_e_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static uint32_T c9_g_emlrt_marshallIn(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c9_b_temporalCounter_i1, const char_T
  *c9_identifier);
static uint32_T c9_h_emlrt_marshallIn(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static const mxArray *c9_i_emlrt_marshallIn
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance, const mxArray
   *c9_b_setSimStateSideEffectsInfo, const char_T *c9_identifier);
static const mxArray *c9_j_emlrt_marshallIn
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c9_u,
   const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc9_Walking01_withElmosInstanceStruct
  *chartInstance);
  ...
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c9_is_active_c9_Walking01_withElmos = 0U;
  *chartInstance->c9_is_c9_Walking01_withElmos = c9_IN_NO_ACTIVE_CHILD;
  ...
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c9_is_active_c9_Walking01_withElmos == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 6U, *chartInstance->c9_sfEvent);
  }

  if (*chartInstance->c9_is_c9_Walking01_withElmos == c9_IN_Run) {
  ...
  if (*chartInstance->c9_is_c9_Walking01_withElmos == c9_IN_Init) {
...
static void ext_mode_exec_c9_Walking01_withElmos
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance)
{
  c9_update_debugger_state_c9_Walking01_withElmos(chartInstance);
}
  ...
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  c9_f_hoistedGlobal = *chartInstance->c9_is_active_c9_Walking01_withElmos;
  c9_f_u = c9_f_hoistedGlobal;
  c9_g_y = NULL;
  sf_mex_assign(&c9_g_y, sf_mex_create("y", &c9_f_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c9_y, 5, c9_g_y);
  c9_g_hoistedGlobal = *chartInstance->c9_is_c9_Walking01_withElmos;
  ...
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c9_st)
{
  ...
  *chartInstance->c9_is_active_c9_Walking01_withElmos = c9_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 5)),
     "is_active_c9_Walking01_withElmos");
  *chartInstance->c9_is_c9_Walking01_withElmos = c9_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 6)),
     "is_c9_Walking01_withElmos");
  ...
  (SFc9_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  uint32_T c9_u0;
  boolean_T c9_out;
  c9_set_sim_state_side_effects_c9_Walking01_withElmos(chartInstance);
  ...
  *chartInstance->c9_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c9_is_active_c9_Walking01_withElmos == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 6U, *chartInstance->c9_sfEvent);
    *chartInstance->c9_is_active_c9_Walking01_withElmos = 1U;
    ...
    *chartInstance->c9_is_c9_Walking01_withElmos = c9_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c9_sfEvent);
    *chartInstance->c9_temporalCounter_i1 = 0U;
    ...
    *chartInstance->c9_ErrorCount = 0.0;
    ...
    switch (*chartInstance->c9_is_c9_Walking01_withElmos) {
     case c9_IN_Init:
      CV_CHART_EVAL(6, 0, 1);
      ...
      if (c9_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c9_sfEvent);
        *chartInstance->c9_is_c9_Walking01_withElmos = c9_IN_Run;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c9_sfEvent);
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_Walking01_withElmosInstanceStruct *chartInstance;
  chartInstance = (SFc9_Walking01_withElmosInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_Walking01_withElmos_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_isStable = (boolean_T *)ssGetDWork_wrapper(chartInstance->S,
    1);
  chartInstance->c9_is_active_c9_Walking01_withElmos = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 2);
  chartInstance->c9_is_c9_Walking01_withElmos = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 3);
...
void sf_c9_Walking01_withElmos_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c9_Walking01_withElmos_get_post_codegen_info(void);
mxArray *sf_c9_Walking01_withElmos_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c9_Walking01_withElmos_get_post_codegen_info
      ();
...
mxArray *sf_c9_Walking01_withElmos_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_Walking01_withElmos_jit_fallback_info(void)
{
...
mxArray *sf_c9_Walking01_withElmos_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_Walking01_withElmos(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[12],T\"ErrorCount\",},{M[1],M[8],T\"q_clean\",},{M[3],M[34],T\"Counter_last\",},{M[3],M[18],T\"dq_last\",},{M[3],M[17],T\"q_last\",},{M[8],M[0],T\"is_active_c9_Walking01_withElmos\",},{M[9],M[0],T\"is_c9_Walking01_withElmos\",},{M[9],M[27],T\"is_Run\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[20],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_Walking01_withElmos_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc9_Walking01_withElmosInstanceStruct *)
...
static void sf_opaque_initialize_c9_Walking01_withElmos(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc9_Walking01_withElmosInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc9_Walking01_withElmosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_Walking01_withElmos
    ((SFc9_Walking01_withElmosInstanceStruct*) chartInstanceVar);
  initialize_c9_Walking01_withElmos((SFc9_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_Walking01_withElmos(void *chartInstanceVar)
{
  enable_c9_Walking01_withElmos((SFc9_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c9_Walking01_withElmos(void *chartInstanceVar)
{
  disable_c9_Walking01_withElmos((SFc9_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_Walking01_withElmos(void *chartInstanceVar)
{
  sf_gateway_c9_Walking01_withElmos((SFc9_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c9_Walking01_withElmos(void
  *chartInstanceVar)
{
  ext_mode_exec_c9_Walking01_withElmos((SFc9_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c9_Walking01_withElmos(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c9_Walking01_withElmos
    ((SFc9_Walking01_withElmosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c9_Walking01_withElmos(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c9_Walking01_withElmos((SFc9_Walking01_withElmosInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c9_Walking01_withElmos(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_Walking01_withElmosInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c9_Walking01_withElmos((SFc9_Walking01_withElmosInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_Walking01_withElmos((SFc9_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_Walking01_withElmos(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c9_Walking01_withElmos
      ((SFc9_Walking01_withElmosInstanceStruct*)(chartInfo->chartInstance));
  }
}

mxArray *sf_c9_Walking01_withElmos_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c9_Walking01_withElmos(SimStruct *S)
{
...
static void mdlRTW_c9_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_Walking01_withElmos(SimStruct *S)
{
  SFc9_Walking01_withElmosInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc9_Walking01_withElmosInstanceStruct *)utMalloc(sizeof
    (SFc9_Walking01_withElmosInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_Walking01_withElmosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_Walking01_withElmos;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_Walking01_withElmos;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_Walking01_withElmos;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_Walking01_withElmos;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c9_Walking01_withElmos;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_Walking01_withElmos;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_Walking01_withElmos;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_Walking01_withElmos;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_Walking01_withElmos;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_Walking01_withElmos;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_Walking01_withElmos;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c9_Walking01_withElmos;
...
void c9_Walking01_withElmos_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_Walking01_withElmos(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_Walking01_withElmos_method_dispatcher.\n"
