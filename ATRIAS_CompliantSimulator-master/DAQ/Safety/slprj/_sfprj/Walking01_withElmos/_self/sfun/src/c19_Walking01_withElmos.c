...
static void initialize_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void initialize_params_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void enable_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void disable_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void c19_update_debugger_state_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void set_sim_state_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c19_st);
static void finalize_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void sf_gateway_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void mdl_start_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void c19_chartstep_c19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static void initSimStructsc19_Walking01_withElmos
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_emlrt_marshallIn(SFc19_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c19_b_dq_clean, const char_T *c19_identifier,
  real_T c19_y[13]);
static void c19_b_emlrt_marshallIn(SFc19_Walking01_withElmosInstanceStruct
...
static const mxArray *c19_g_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_c_emlrt_marshallIn(SFc19_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static void c19_realmax(SFc19_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *c19_h_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_d_emlrt_marshallIn(SFc19_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint8_T c19_e_emlrt_marshallIn(SFc19_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c19_b_is_active_c19_Walking01_withElmos, const
  char_T *c19_identifier);
static uint8_T c19_f_emlrt_marshallIn(SFc19_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void init_dsm_address_info(SFc19_Walking01_withElmosInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc19_Walking01_withElmosInstanceStruct
  *chartInstance);
  ...
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_Walking01_withElmos = 0U;
}
  ...
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  c19_hoistedGlobal = chartInstance->c19_is_active_c19_Walking01_withElmos;
  ...
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c19_st)
{
  ...
  chartInstance->c19_is_active_c19_Walking01_withElmos = c19_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 2)),
     "is_active_c19_Walking01_withElmos");
  sf_mex_destroy(&c19_u);
  c19_update_debugger_state_c19_Walking01_withElmos(chartInstance);
  ...
  (SFc19_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_sfEvent = CALL_EVENT;
  c19_chartstep_c19_Walking01_withElmos(chartInstance);
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_Walking01_withElmosInstanceStruct *chartInstance;
  chartInstance = (SFc19_Walking01_withElmosInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c19_Walking01_withElmos_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c19_identifier)
{
  ...
  c19_y = c19_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c19_b_is_active_c19_Walking01_withElmos), &c19_thisId);
  sf_mex_destroy(&c19_b_is_active_c19_Walking01_withElmos);
  return c19_y;
}
...
void sf_c19_Walking01_withElmos_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c19_Walking01_withElmos_get_post_codegen_info(void);
mxArray *sf_c19_Walking01_withElmos_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c19_Walking01_withElmos_get_post_codegen_info();
...
mxArray *sf_c19_Walking01_withElmos_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c19_Walking01_withElmos_jit_fallback_info(void)
{
...
mxArray *sf_c19_Walking01_withElmos_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c19_Walking01_withElmos(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[10],T\"dq_clean\",},{M[1],M[5],T\"q_clean\",},{M[8],M[0],T\"is_active_c19_Walking01_withElmos\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_Walking01_withElmos_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc19_Walking01_withElmosInstanceStruct *)
...
static void sf_opaque_initialize_c19_Walking01_withElmos(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_Walking01_withElmosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c19_Walking01_withElmos
    ((SFc19_Walking01_withElmosInstanceStruct*) chartInstanceVar);
  initialize_c19_Walking01_withElmos((SFc19_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c19_Walking01_withElmos(void *chartInstanceVar)
{
  enable_c19_Walking01_withElmos((SFc19_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c19_Walking01_withElmos(void *chartInstanceVar)
{
  disable_c19_Walking01_withElmos((SFc19_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c19_Walking01_withElmos(void *chartInstanceVar)
{
  sf_gateway_c19_Walking01_withElmos((SFc19_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c19_Walking01_withElmos(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c19_Walking01_withElmos
    ((SFc19_Walking01_withElmosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c19_Walking01_withElmos(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c19_Walking01_withElmos((SFc19_Walking01_withElmosInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c19_Walking01_withElmos(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_Walking01_withElmosInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c19_Walking01_withElmos((SFc19_Walking01_withElmosInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc19_Walking01_withElmos((SFc19_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_Walking01_withElmos(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c19_Walking01_withElmos
      ((SFc19_Walking01_withElmosInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c19_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c19_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_Walking01_withElmos(SimStruct *S)
{
  SFc19_Walking01_withElmosInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc19_Walking01_withElmosInstanceStruct *)utMalloc(sizeof
    (SFc19_Walking01_withElmosInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_Walking01_withElmosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c19_Walking01_withElmos;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_Walking01_withElmos;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c19_Walking01_withElmos;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c19_Walking01_withElmos;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c19_Walking01_withElmos;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_Walking01_withElmos;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_Walking01_withElmos;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_Walking01_withElmos;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_Walking01_withElmos;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_Walking01_withElmos;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c19_Walking01_withElmos;
...
void c19_Walking01_withElmos_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_Walking01_withElmos(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_Walking01_withElmos_method_dispatcher.\n"
