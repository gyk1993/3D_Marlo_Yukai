...
static void initialize_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void initialize_params_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void enable_c7_Walking01_withElmos(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance);
static void disable_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void set_sim_state_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c7_st);
static void finalize_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void sf_gateway_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void mdl_start_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void c7_chartstep_c7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void initSimStructsc7_Walking01_withElmos
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void c7_M_to_ZYX(SFc7_Walking01_withElmosInstanceStruct *chartInstance,
  real_T c7_M[9], real_T c7_EulerAngles[3]);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static void c7_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_b_YawRollover, const char_T *c7_identifier,
  real_T c7_y[2]);
static void c7_b_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
...
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_c_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_b_R0, const char_T *c7_identifier, real_T
  c7_y[9]);
static void c7_d_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[9]);
...
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_e_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_b_dZYX, const char_T *c7_identifier, real_T
  c7_y[3]);
static void c7_f_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[3]);
...
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_g_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
...
static void c7_eml_scalar_eg(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance);
static void c7_threshold(SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static void c7_eml_error(SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static real_T c7_atan2(SFc7_Walking01_withElmosInstanceStruct *chartInstance,
  real_T c7_y, real_T c7_x);
static real_T c7_squeeze(SFc7_Walking01_withElmosInstanceStruct *chartInstance,
  real_T c7_a);
static void c7_Rz(SFc7_Walking01_withElmosInstanceStruct *chartInstance, real_T
                  c7_t, real_T c7_R[9]);
static real_T c7_getYawRollover(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, real_T c7_CurrentYaw, real_T c7_PreviousYaw);
static void c7_b_eml_scalar_eg(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance);
static void c7_mldivide(SFc7_Walking01_withElmosInstanceStruct *chartInstance,
  real_T c7_A[9], real_T c7_B[3], real_T c7_Y[3]);
static real_T c7_rdivide(SFc7_Walking01_withElmosInstanceStruct *chartInstance,
  real_T c7_x, real_T c7_y);
static void c7_eml_warning(SFc7_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_h_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_i_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_Walking01_withElmos, const
  char_T *c7_identifier);
static uint8_T c7_j_emlrt_marshallIn(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc7_Walking01_withElmosInstanceStruct
  *chartInstance);
  ...
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_Walking01_withElmos = 0U;
}
  ...
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  c7_hoistedGlobal = chartInstance->c7_is_active_c7_Walking01_withElmos;
  ...
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_Walking01_withElmos = c7_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 5)),
     "is_active_c7_Walking01_withElmos");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_Walking01_withElmos(chartInstance);
  ...
  (SFc7_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_Walking01_withElmos(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_Walking01_withElmosInstanceStruct *chartInstance;
  chartInstance = (SFc7_Walking01_withElmosInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_Walking01_withElmos_get_eml_resolved_functions_info(void)
{
...
static void c7_info_helper(const mxArray **c7_info)
{
  ...
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(1432837203U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_Walking01_withElmos), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_Walking01_withElmos);
  return c7_y;
}
...
void sf_c7_Walking01_withElmos_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c7_Walking01_withElmos_get_post_codegen_info(void);
mxArray *sf_c7_Walking01_withElmos_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_Walking01_withElmos_get_post_codegen_info
      ();
...
mxArray *sf_c7_Walking01_withElmos_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_Walking01_withElmos_jit_fallback_info(void)
{
...
mxArray *sf_c7_Walking01_withElmos_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_Walking01_withElmos(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[13],T\"R0\",},{M[1],M[5],T\"Rk\",},{M[1],M[18],T\"YawRollover\",},{M[1],M[10],T\"ZYX\",},{M[1],M[16],T\"dZYX\",},{M[8],M[0],T\"is_active_c7_Walking01_withElmos\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_Walking01_withElmos_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_Walking01_withElmosInstanceStruct *)
...
static void sf_opaque_initialize_c7_Walking01_withElmos(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_Walking01_withElmosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_Walking01_withElmos
    ((SFc7_Walking01_withElmosInstanceStruct*) chartInstanceVar);
  initialize_c7_Walking01_withElmos((SFc7_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_Walking01_withElmos(void *chartInstanceVar)
{
  enable_c7_Walking01_withElmos((SFc7_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_Walking01_withElmos(void *chartInstanceVar)
{
  disable_c7_Walking01_withElmos((SFc7_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_Walking01_withElmos(void *chartInstanceVar)
{
  sf_gateway_c7_Walking01_withElmos((SFc7_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_Walking01_withElmos(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_Walking01_withElmos
    ((SFc7_Walking01_withElmosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_Walking01_withElmos(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_Walking01_withElmos((SFc7_Walking01_withElmosInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c7_Walking01_withElmos(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_Walking01_withElmosInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_Walking01_withElmos((SFc7_Walking01_withElmosInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_Walking01_withElmos((SFc7_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_Walking01_withElmos(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c7_Walking01_withElmos
      ((SFc7_Walking01_withElmosInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_Walking01_withElmos(SimStruct *S)
{
  SFc7_Walking01_withElmosInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_Walking01_withElmosInstanceStruct *)utMalloc(sizeof
    (SFc7_Walking01_withElmosInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_Walking01_withElmosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_Walking01_withElmos;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_Walking01_withElmos;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_Walking01_withElmos;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_Walking01_withElmos;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_Walking01_withElmos;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_Walking01_withElmos;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_Walking01_withElmos;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_Walking01_withElmos;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_Walking01_withElmos;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_Walking01_withElmos;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_Walking01_withElmos;
...
void c7_Walking01_withElmos_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_Walking01_withElmos(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_Walking01_withElmos_method_dispatcher.\n"
