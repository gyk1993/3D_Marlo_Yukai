...
static const char * c2_debug_family_names[7] = { "TorsoCOMRollOffset",
  "TorsoCOMPitchOffset", "nargin", "nargout", "q_in", "TorsoCOMOffsets", "q" };

/* Function Declarations */
static void initialize_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void initialize_params_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void enable_c2_Walking01_withElmos(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance);
static void disable_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void set_sim_state_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void sf_gateway_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void mdl_start_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void c2_chartstep_c2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void initSimStructsc2_Walking01_withElmos
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c2_b_q, const char_T *c2_identifier, real_T
  c2_y[13]);
static void c2_b_emlrt_marshallIn(SFc2_Walking01_withElmosInstanceStruct
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_realmax(SFc2_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Walking01_withElmos, const
  char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance);
  ...
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Walking01_withElmos = 0U;
}
  ...
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  for (c2_i0 = 0; c2_i0 < 13; c2_i0++) {
    c2_u[c2_i0] = (*chartInstance->c2_q)[c2_i0];
  }

  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 1, 13), false);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Walking01_withElmos;
  ...
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  for (c2_i1 = 0; c2_i1 < 13; c2_i1++) {
    (*chartInstance->c2_q)[c2_i1] = c2_dv0[c2_i1];
  }

  chartInstance->c2_is_active_c2_Walking01_withElmos = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_Walking01_withElmos");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Walking01_withElmos(chartInstance);
  ...
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  for (c2_i2 = 0; c2_i2 < 13; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_q_in)[c2_i2], 0U);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Walking01_withElmos(chartInstance);
  ...
  for (c2_i4 = 0; c2_i4 < 2; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_TorsoCOMOffsets)[c2_i4], 2U);
  }
}
  ...
  (SFc2_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  real_T c2_b_q_in[13];
  int32_T c2_i6;
  real_T c2_b_TorsoCOMOffsets[2];
  uint32_T c2_debug_family_var_map[7];
  real_T c2_TorsoCOMRollOffset;
  real_T c2_TorsoCOMPitchOffset;
  ...
  int32_T c2_i7;
  int32_T c2_i8;
  static int32_T c2_iv0[8] = { 3, 4, 5, 6, 7, 8, 10, 11 };
  ...
  for (c2_i5 = 0; c2_i5 < 13; c2_i5++) {
    c2_b_q_in[c2_i5] = (*chartInstance->c2_q_in)[c2_i5];
  }

  for (c2_i6 = 0; c2_i6 < 2; c2_i6++) {
    c2_b_TorsoCOMOffsets[c2_i6] = (*chartInstance->c2_TorsoCOMOffsets)[c2_i6];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_TorsoCOMRollOffset, 0U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_TorsoCOMPitchOffset, 1U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 3U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_b_q_in, 4U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_b_TorsoCOMOffsets, 5U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_b_q, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
  c2_A = c2_b_TorsoCOMOffsets[0] * 3.1415926535897931;
  c2_x = c2_A;
  c2_b_x = c2_x;
  c2_c_x = c2_b_x;
  c2_TorsoCOMRollOffset = c2_c_x / 180.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 5);
  c2_b_A = c2_b_TorsoCOMOffsets[1] * 3.1415926535897931;
  c2_d_x = c2_b_A;
  c2_e_x = c2_d_x;
  c2_f_x = c2_e_x;
  c2_TorsoCOMPitchOffset = c2_f_x / 180.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 7);
  for (c2_i7 = 0; c2_i7 < 13; c2_i7++) {
    c2_b_q[c2_i7] = c2_b_q_in[c2_i7];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 8);
  c2_b_q[1] += c2_TorsoCOMRollOffset;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 9);
  c2_b_q[9] -= c2_TorsoCOMRollOffset;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 10);
  c2_b_q[12] += c2_TorsoCOMRollOffset;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 12);
  c2_b_q[2] += c2_TorsoCOMPitchOffset;
  ...
  for (c2_i8 = 0; c2_i8 < 8; c2_i8++) {
    c2_c_q[c2_i8] = c2_b_q[c2_iv0[c2_i8]] - c2_TorsoCOMPitchOffset;
  }

  for (c2_i9 = 0; c2_i9 < 8; c2_i9++) {
    c2_b_q[c2_iv0[c2_i9]] = c2_c_q[c2_i9];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -13);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i10 = 0; c2_i10 < 13; c2_i10++) {
    (*chartInstance->c2_q)[c2_i10] = c2_b_q[c2_i10];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Walking01_withElmosInstanceStruct *chartInstance;
  chartInstance = (SFc2_Walking01_withElmosInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i11 = 0; c2_i11 < 13; c2_i11++) {
    c2_b_inData[c2_i11] = (*(real_T (*)[13])c2_inData)[c2_i11];
  }
  ...
  real_T c2_y[13])
{
  ...
  int32_T c2_i13;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv1, 1, 0, 0U, 1, 0U, 1, 13);
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_q), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_b_q);
  for (c2_i14 = 0; c2_i14 < 13; c2_i14++) {
    (*(real_T (*)[13])c2_outData)[c2_i14] = c2_y[c2_i14];
  }
...
const mxArray *sf_c2_Walking01_withElmos_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("colon"), "name", "name", 7);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 8);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("colon"), "name", "name", 8);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!is_flint_colon"),
                  "context", "context", 10);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isfinite"), "name", "name", 10);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 12);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isinf"), "name", "name", 12);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 14);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isnan"), "name", "name", 14);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkFlintRange"),
                  "context", "context", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("flintmax"), "name", "name", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flintmax.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1348213516U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkFlintRange"),
                  "context", "context", 23);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 23);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 26);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("realmax"), "name", "name", 26);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_flint_colon"),
                  "context", "context", 30);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("floor"), "name", "name", 30);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Walking01_withElmos), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Walking01_withElmos);
  return c2_y;
}
...
static void init_simulink_io_address(SFc2_Walking01_withElmosInstanceStruct
  *chartInstance)
{
  chartInstance->c2_q_in = (real_T (*)[13])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_q = (real_T (*)[13])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_TorsoCOMOffsets = (real_T (*)[2])
...
void sf_c2_Walking01_withElmos_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_Walking01_withElmos_get_post_codegen_info(void);
mxArray *sf_c2_Walking01_withElmos_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Walking01_withElmos_get_post_codegen_info
      ();
...
mxArray *sf_c2_Walking01_withElmos_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Walking01_withElmos_jit_fallback_info(void)
{
...
mxArray *sf_c2_Walking01_withElmos_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Walking01_withElmos(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"q\",},{M[8],M[0],T\"is_active_c2_Walking01_withElmos\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Walking01_withElmos_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_Walking01_withElmosInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c2_q_in);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c2_q);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c2_TorsoCOMOffsets);
      }
    } else {
...
static void sf_opaque_initialize_c2_Walking01_withElmos(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_Walking01_withElmosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_Walking01_withElmos
    ((SFc2_Walking01_withElmosInstanceStruct*) chartInstanceVar);
  initialize_c2_Walking01_withElmos((SFc2_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_Walking01_withElmos(void *chartInstanceVar)
{
  enable_c2_Walking01_withElmos((SFc2_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_Walking01_withElmos(void *chartInstanceVar)
{
  disable_c2_Walking01_withElmos((SFc2_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_Walking01_withElmos(void *chartInstanceVar)
{
  sf_gateway_c2_Walking01_withElmos((SFc2_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Walking01_withElmos(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_Walking01_withElmos
    ((SFc2_Walking01_withElmosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Walking01_withElmos(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_Walking01_withElmos((SFc2_Walking01_withElmosInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_Walking01_withElmos(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Walking01_withElmosInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_Walking01_withElmos((SFc2_Walking01_withElmosInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_Walking01_withElmos((SFc2_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Walking01_withElmos(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_Walking01_withElmos
      ((SFc2_Walking01_withElmosInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Walking01_withElmos(SimStruct *S)
{
  SFc2_Walking01_withElmosInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_Walking01_withElmosInstanceStruct *)utMalloc(sizeof
    (SFc2_Walking01_withElmosInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_Walking01_withElmosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Walking01_withElmos;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Walking01_withElmos;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Walking01_withElmos;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Walking01_withElmos;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Walking01_withElmos;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Walking01_withElmos;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Walking01_withElmos;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Walking01_withElmos;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Walking01_withElmos;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Walking01_withElmos;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Walking01_withElmos;
...
void c2_Walking01_withElmos_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Walking01_withElmos(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Walking01_withElmos_method_dispatcher.\n"
