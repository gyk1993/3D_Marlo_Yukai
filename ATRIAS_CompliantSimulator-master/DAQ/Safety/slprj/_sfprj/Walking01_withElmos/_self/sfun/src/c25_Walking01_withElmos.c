...
static void initialize_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void initialize_params_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void enable_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void disable_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void c25_update_debugger_state_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void set_sim_state_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c25_st);
static void finalize_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void sf_gateway_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void mdl_start_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void c25_chartstep_c25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
static void initSimStructsc25_Walking01_withElmos
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance);
...
static const mxArray *c25_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static void c25_emlrt_marshallIn(SFc25_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c25_b_y, const char_T *c25_identifier, real_T
  c25_c_y[6]);
static void c25_b_emlrt_marshallIn(SFc25_Walking01_withElmosInstanceStruct
...
static const mxArray *c25_d_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static real_T c25_c_emlrt_marshallIn(SFc25_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c25_b_u, const emlrtMsgIdentifier *c25_parentId);
...
static const mxArray *c25_e_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static int32_T c25_d_emlrt_marshallIn(SFc25_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c25_b_u, const emlrtMsgIdentifier *c25_parentId);
static void c25_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData);
static uint8_T c25_e_emlrt_marshallIn(SFc25_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c25_b_is_active_c25_Walking01_withElmos, const
  char_T *c25_identifier);
static uint8_T c25_f_emlrt_marshallIn(SFc25_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c25_b_u, const emlrtMsgIdentifier *c25_parentId);
static void init_dsm_address_info(SFc25_Walking01_withElmosInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc25_Walking01_withElmosInstanceStruct
  *chartInstance);
  ...
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c25_is_active_c25_Walking01_withElmos = 0U;
}
  ...
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  c25_hoistedGlobal = chartInstance->c25_is_active_c25_Walking01_withElmos;
  ...
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c25_st)
{
  ...
  chartInstance->c25_is_active_c25_Walking01_withElmos = c25_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c25_b_u, 1)),
     "is_active_c25_Walking01_withElmos");
  sf_mex_destroy(&c25_b_u);
  c25_update_debugger_state_c25_Walking01_withElmos(chartInstance);
  ...
  (SFc25_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c25_sfEvent = CALL_EVENT;
  c25_chartstep_c25_Walking01_withElmos(chartInstance);
  ...
  *c25_inData)
{
  ...
  const mxArray *c25_b_y = NULL;
  SFc25_Walking01_withElmosInstanceStruct *chartInstance;
  chartInstance = (SFc25_Walking01_withElmosInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c25_Walking01_withElmos_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c25_identifier)
{
  ...
  c25_b_y = c25_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c25_b_is_active_c25_Walking01_withElmos), &c25_thisId);
  sf_mex_destroy(&c25_b_is_active_c25_Walking01_withElmos);
  return c25_b_y;
}
...
void sf_c25_Walking01_withElmos_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c25_Walking01_withElmos_get_post_codegen_info(void);
mxArray *sf_c25_Walking01_withElmos_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c25_Walking01_withElmos_get_post_codegen_info();
...
mxArray *sf_c25_Walking01_withElmos_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c25_Walking01_withElmos_jit_fallback_info(void)
{
...
mxArray *sf_c25_Walking01_withElmos_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c25_Walking01_withElmos(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c25_Walking01_withElmos\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c25_Walking01_withElmos_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc25_Walking01_withElmosInstanceStruct *)
...
static void sf_opaque_initialize_c25_Walking01_withElmos(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc25_Walking01_withElmosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c25_Walking01_withElmos
    ((SFc25_Walking01_withElmosInstanceStruct*) chartInstanceVar);
  initialize_c25_Walking01_withElmos((SFc25_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c25_Walking01_withElmos(void *chartInstanceVar)
{
  enable_c25_Walking01_withElmos((SFc25_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c25_Walking01_withElmos(void *chartInstanceVar)
{
  disable_c25_Walking01_withElmos((SFc25_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c25_Walking01_withElmos(void *chartInstanceVar)
{
  sf_gateway_c25_Walking01_withElmos((SFc25_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c25_Walking01_withElmos(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c25_Walking01_withElmos
    ((SFc25_Walking01_withElmosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c25_Walking01_withElmos(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c25_Walking01_withElmos((SFc25_Walking01_withElmosInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c25_Walking01_withElmos(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc25_Walking01_withElmosInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c25_Walking01_withElmos((SFc25_Walking01_withElmosInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc25_Walking01_withElmos((SFc25_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c25_Walking01_withElmos(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c25_Walking01_withElmos
      ((SFc25_Walking01_withElmosInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c25_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c25_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c25_Walking01_withElmos(SimStruct *S)
{
  SFc25_Walking01_withElmosInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc25_Walking01_withElmosInstanceStruct *)utMalloc(sizeof
    (SFc25_Walking01_withElmosInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc25_Walking01_withElmosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c25_Walking01_withElmos;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c25_Walking01_withElmos;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c25_Walking01_withElmos;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c25_Walking01_withElmos;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c25_Walking01_withElmos;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c25_Walking01_withElmos;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c25_Walking01_withElmos;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c25_Walking01_withElmos;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c25_Walking01_withElmos;
  chartInstance->chartInfo.mdlStart = mdlStart_c25_Walking01_withElmos;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c25_Walking01_withElmos;
...
void c25_Walking01_withElmos_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c25_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c25_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c25_Walking01_withElmos(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c25_Walking01_withElmos_method_dispatcher.\n"
