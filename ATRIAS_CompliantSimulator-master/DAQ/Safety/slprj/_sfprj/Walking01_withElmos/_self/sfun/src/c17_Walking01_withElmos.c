...
static void initialize_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static void initialize_params_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static void enable_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static void disable_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static void set_sim_state_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c17_st);
static void finalize_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static void sf_gateway_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static void mdl_start_c17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
static void initSimStructsc17_Walking01_withElmos
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_emlrt_marshallIn(SFc17_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c17_b_Temperatures, const char_T
  *c17_identifier, real_T c17_y[30]);
static void c17_b_emlrt_marshallIn(SFc17_Walking01_withElmosInstanceStruct
...
static const mxArray *c17_b_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_c_emlrt_marshallIn(SFc17_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
...
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_d_emlrt_marshallIn(SFc17_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_e_emlrt_marshallIn(SFc17_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c17_b_is_active_c17_Walking01_withElmos, const
  char_T *c17_identifier);
static uint8_T c17_f_emlrt_marshallIn(SFc17_Walking01_withElmosInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void init_dsm_address_info(SFc17_Walking01_withElmosInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc17_Walking01_withElmosInstanceStruct
  *chartInstance);
  ...
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_Walking01_withElmos = 0U;
}
  ...
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance)
{
  ...
  c17_hoistedGlobal = chartInstance->c17_is_active_c17_Walking01_withElmos;
  ...
  (SFc17_Walking01_withElmosInstanceStruct *chartInstance, const mxArray *c17_st)
{
  ...
  chartInstance->c17_is_active_c17_Walking01_withElmos = c17_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 1)),
     "is_active_c17_Walking01_withElmos");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_Walking01_withElmos(chartInstance);
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_Walking01_withElmosInstanceStruct *chartInstance;
  chartInstance = (SFc17_Walking01_withElmosInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c17_Walking01_withElmos_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c17_identifier)
{
  ...
  c17_y = c17_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_Walking01_withElmos), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_Walking01_withElmos);
  return c17_y;
}
...
void sf_c17_Walking01_withElmos_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c17_Walking01_withElmos_get_post_codegen_info(void);
mxArray *sf_c17_Walking01_withElmos_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c17_Walking01_withElmos_get_post_codegen_info();
...
mxArray *sf_c17_Walking01_withElmos_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c17_Walking01_withElmos_jit_fallback_info(void)
{
...
mxArray *sf_c17_Walking01_withElmos_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c17_Walking01_withElmos(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"Temperatures\",},{M[8],M[0],T\"is_active_c17_Walking01_withElmos\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_Walking01_withElmos_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc17_Walking01_withElmosInstanceStruct *)
...
static void sf_opaque_initialize_c17_Walking01_withElmos(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_Walking01_withElmosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c17_Walking01_withElmos
    ((SFc17_Walking01_withElmosInstanceStruct*) chartInstanceVar);
  initialize_c17_Walking01_withElmos((SFc17_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c17_Walking01_withElmos(void *chartInstanceVar)
{
  enable_c17_Walking01_withElmos((SFc17_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c17_Walking01_withElmos(void *chartInstanceVar)
{
  disable_c17_Walking01_withElmos((SFc17_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c17_Walking01_withElmos(void *chartInstanceVar)
{
  sf_gateway_c17_Walking01_withElmos((SFc17_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c17_Walking01_withElmos(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c17_Walking01_withElmos
    ((SFc17_Walking01_withElmosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c17_Walking01_withElmos(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c17_Walking01_withElmos((SFc17_Walking01_withElmosInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c17_Walking01_withElmos(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_Walking01_withElmosInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c17_Walking01_withElmos((SFc17_Walking01_withElmosInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc17_Walking01_withElmos((SFc17_Walking01_withElmosInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_Walking01_withElmos(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c17_Walking01_withElmos
      ((SFc17_Walking01_withElmosInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c17_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c17_Walking01_withElmos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_Walking01_withElmos(SimStruct *S)
{
  SFc17_Walking01_withElmosInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc17_Walking01_withElmosInstanceStruct *)utMalloc(sizeof
    (SFc17_Walking01_withElmosInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_Walking01_withElmosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c17_Walking01_withElmos;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c17_Walking01_withElmos;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c17_Walking01_withElmos;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c17_Walking01_withElmos;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c17_Walking01_withElmos;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c17_Walking01_withElmos;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c17_Walking01_withElmos;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c17_Walking01_withElmos;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_Walking01_withElmos;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_Walking01_withElmos;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c17_Walking01_withElmos;
...
void c17_Walking01_withElmos_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_Walking01_withElmos(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_Walking01_withElmos(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_Walking01_withElmos_method_dispatcher.\n"
