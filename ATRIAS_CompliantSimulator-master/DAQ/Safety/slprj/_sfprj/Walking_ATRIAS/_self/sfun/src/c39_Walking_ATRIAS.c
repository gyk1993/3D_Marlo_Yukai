...
static void initialize_c39_Walking_ATRIAS(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance);
static void initialize_params_c39_Walking_ATRIAS
  (SFc39_Walking_ATRIASInstanceStruct *chartInstance);
static void enable_c39_Walking_ATRIAS(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance);
static void disable_c39_Walking_ATRIAS(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance);
static void c39_update_debugger_state_c39_Walking_ATRIAS
  (SFc39_Walking_ATRIASInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c39_Walking_ATRIAS
  (SFc39_Walking_ATRIASInstanceStruct *chartInstance);
static void set_sim_state_c39_Walking_ATRIAS(SFc39_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c39_st);
static void finalize_c39_Walking_ATRIAS(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance);
static void sf_gateway_c39_Walking_ATRIAS(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance);
static void mdl_start_c39_Walking_ATRIAS(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance);
static void initSimStructsc39_Walking_ATRIAS(SFc39_Walking_ATRIASInstanceStruct *
  chartInstance);
static uint32_T c39_EncodeSwitches(SFc39_Walking_ATRIASInstanceStruct
...
static const mxArray *c39_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static real_T c39_emlrt_marshallIn(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c39_b_LimitSwitchesEncoded, const char_T
  *c39_identifier);
static real_T c39_b_emlrt_marshallIn(SFc39_Walking_ATRIASInstanceStruct
...
static const mxArray *c39_c_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static void c39_c_emlrt_marshallIn(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId,
  uint32_T c39_y[6]);
...
static const mxArray *c39_d_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static uint32_T c39_d_emlrt_marshallIn(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId);
...
static const mxArray *c39_e_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static int32_T c39_e_emlrt_marshallIn(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId);
static void c39_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c39_mxArrayInData, const char_T *c39_varName, void *c39_outData);
static uint8_T c39_f_emlrt_marshallIn(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c39_b_is_active_c39_Walking_ATRIAS, const
  char_T *c39_identifier);
static uint8_T c39_g_emlrt_marshallIn(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId);
static void init_dsm_address_info(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc39_Walking_ATRIASInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c39_is_active_c39_Walking_ATRIAS = 0U;
}
  ...
  (SFc39_Walking_ATRIASInstanceStruct *chartInstance)
{
  ...
  c39_b_hoistedGlobal = chartInstance->c39_is_active_c39_Walking_ATRIAS;
  ...
  chartInstance, const mxArray *c39_st)
{
  ...
  *chartInstance->c39_LimitSwitchesEncoded = c39_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c39_is_active_c39_Walking_ATRIAS = c39_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c39_u, 1)),
     "is_active_c39_Walking_ATRIAS");
  sf_mex_destroy(&c39_u);
  c39_update_debugger_state_c39_Walking_ATRIAS(chartInstance);
  ...
  *c39_inData)
{
  ...
  const mxArray *c39_y = NULL;
  SFc39_Walking_ATRIASInstanceStruct *chartInstance;
  chartInstance = (SFc39_Walking_ATRIASInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c39_Walking_ATRIAS_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c39_identifier)
{
  ...
  c39_y = c39_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c39_b_is_active_c39_Walking_ATRIAS), &c39_thisId);
  sf_mex_destroy(&c39_b_is_active_c39_Walking_ATRIAS);
  return c39_y;
}
...
void sf_c39_Walking_ATRIAS_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c39_Walking_ATRIAS_get_post_codegen_info(void);
mxArray *sf_c39_Walking_ATRIAS_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c39_Walking_ATRIAS_get_post_codegen_info();
...
mxArray *sf_c39_Walking_ATRIAS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c39_Walking_ATRIAS_jit_fallback_info(void)
{
...
mxArray *sf_c39_Walking_ATRIAS_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c39_Walking_ATRIAS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"LimitSwitchesEncoded\",},{M[8],M[0],T\"is_active_c39_Walking_ATRIAS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c39_Walking_ATRIAS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc39_Walking_ATRIASInstanceStruct *)
...
static void sf_opaque_initialize_c39_Walking_ATRIAS(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc39_Walking_ATRIASInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
  initialize_c39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c39_Walking_ATRIAS(void *chartInstanceVar)
{
  enable_c39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c39_Walking_ATRIAS(void *chartInstanceVar)
{
  disable_c39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c39_Walking_ATRIAS(void *chartInstanceVar)
{
  sf_gateway_c39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c39_Walking_ATRIAS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c39_Walking_ATRIAS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c39_Walking_ATRIAS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc39_Walking_ATRIASInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc39_Walking_ATRIAS((SFc39_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c39_Walking_ATRIAS(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c39_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c39_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c39_Walking_ATRIAS(SimStruct *S)
{
  SFc39_Walking_ATRIASInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc39_Walking_ATRIASInstanceStruct *)utMalloc(sizeof
    (SFc39_Walking_ATRIASInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc39_Walking_ATRIASInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c39_Walking_ATRIAS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c39_Walking_ATRIAS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c39_Walking_ATRIAS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c39_Walking_ATRIAS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c39_Walking_ATRIAS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c39_Walking_ATRIAS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c39_Walking_ATRIAS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c39_Walking_ATRIAS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c39_Walking_ATRIAS;
  chartInstance->chartInfo.mdlStart = mdlStart_c39_Walking_ATRIAS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c39_Walking_ATRIAS;
...
void c39_Walking_ATRIAS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c39_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c39_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c39_Walking_ATRIAS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c39_Walking_ATRIAS_method_dispatcher.\n"
