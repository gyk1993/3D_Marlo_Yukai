#ifndef __c49_Walking_ATRIAS_h__
#define __c49_Walking_ATRIAS_h__
...
#ifndef typedef_SFc49_Walking_ATRIASInstanceStruct
#define typedef_SFc49_Walking_ATRIASInstanceStruct
...
typedef struct {
  ...
  uint8_T c49_is_active_c49_Walking_ATRIAS;
...
#endif                                 /*typedef_SFc49_Walking_ATRIASInstanceStruct*/
...
extern const mxArray *sf_c49_Walking_ATRIAS_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c49_Walking_ATRIAS_get_check_sum(mxArray *plhs[]);
extern void c49_Walking_ATRIAS_method_dispatcher(SimStruct *S, int_T method,
  void *data);
