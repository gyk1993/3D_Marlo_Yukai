...
static void initialize_c35_Walking_ATRIAS(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance);
static void initialize_params_c35_Walking_ATRIAS
  (SFc35_Walking_ATRIASInstanceStruct *chartInstance);
static void enable_c35_Walking_ATRIAS(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance);
static void disable_c35_Walking_ATRIAS(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance);
static void c35_update_debugger_state_c35_Walking_ATRIAS
  (SFc35_Walking_ATRIASInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c35_Walking_ATRIAS
  (SFc35_Walking_ATRIASInstanceStruct *chartInstance);
static void set_sim_state_c35_Walking_ATRIAS(SFc35_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c35_st);
static void finalize_c35_Walking_ATRIAS(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance);
static void sf_gateway_c35_Walking_ATRIAS(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance);
static void mdl_start_c35_Walking_ATRIAS(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance);
static void initSimStructsc35_Walking_ATRIAS(SFc35_Walking_ATRIASInstanceStruct *
  chartInstance);
...
static const mxArray *c35_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_emlrt_marshallIn(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c35_b_measuredCurrent, const char_T
  *c35_identifier, real_T c35_y[10]);
static void c35_b_emlrt_marshallIn(SFc35_Walking_ATRIASInstanceStruct
...
static const mxArray *c35_b_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static real_T c35_c_emlrt_marshallIn(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
...
static const mxArray *c35_c_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static int32_T c35_d_emlrt_marshallIn(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void c35_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData);
static uint8_T c35_e_emlrt_marshallIn(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c35_b_is_active_c35_Walking_ATRIAS, const
  char_T *c35_identifier);
static uint8_T c35_f_emlrt_marshallIn(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void init_dsm_address_info(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc35_Walking_ATRIASInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c35_is_active_c35_Walking_ATRIAS = 0U;
}
  ...
  (SFc35_Walking_ATRIASInstanceStruct *chartInstance)
{
  ...
  c35_hoistedGlobal = chartInstance->c35_is_active_c35_Walking_ATRIAS;
  ...
  chartInstance, const mxArray *c35_st)
{
  ...
  chartInstance->c35_is_active_c35_Walking_ATRIAS = c35_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c35_u, 1)),
     "is_active_c35_Walking_ATRIAS");
  sf_mex_destroy(&c35_u);
  c35_update_debugger_state_c35_Walking_ATRIAS(chartInstance);
  ...
  *c35_inData)
{
  ...
  const mxArray *c35_y = NULL;
  SFc35_Walking_ATRIASInstanceStruct *chartInstance;
  chartInstance = (SFc35_Walking_ATRIASInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c35_Walking_ATRIAS_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c35_identifier)
{
  ...
  c35_y = c35_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c35_b_is_active_c35_Walking_ATRIAS), &c35_thisId);
  sf_mex_destroy(&c35_b_is_active_c35_Walking_ATRIAS);
  return c35_y;
}
...
void sf_c35_Walking_ATRIAS_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c35_Walking_ATRIAS_get_post_codegen_info(void);
mxArray *sf_c35_Walking_ATRIAS_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c35_Walking_ATRIAS_get_post_codegen_info();
...
mxArray *sf_c35_Walking_ATRIAS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c35_Walking_ATRIAS_jit_fallback_info(void)
{
...
mxArray *sf_c35_Walking_ATRIAS_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c35_Walking_ATRIAS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"measuredCurrent\",},{M[8],M[0],T\"is_active_c35_Walking_ATRIAS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c35_Walking_ATRIAS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc35_Walking_ATRIASInstanceStruct *)
...
static void sf_opaque_initialize_c35_Walking_ATRIAS(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc35_Walking_ATRIASInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
  initialize_c35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c35_Walking_ATRIAS(void *chartInstanceVar)
{
  enable_c35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c35_Walking_ATRIAS(void *chartInstanceVar)
{
  disable_c35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c35_Walking_ATRIAS(void *chartInstanceVar)
{
  sf_gateway_c35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c35_Walking_ATRIAS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c35_Walking_ATRIAS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c35_Walking_ATRIAS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc35_Walking_ATRIASInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc35_Walking_ATRIAS((SFc35_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c35_Walking_ATRIAS(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c35_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c35_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c35_Walking_ATRIAS(SimStruct *S)
{
  SFc35_Walking_ATRIASInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc35_Walking_ATRIASInstanceStruct *)utMalloc(sizeof
    (SFc35_Walking_ATRIASInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc35_Walking_ATRIASInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c35_Walking_ATRIAS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c35_Walking_ATRIAS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c35_Walking_ATRIAS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c35_Walking_ATRIAS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c35_Walking_ATRIAS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c35_Walking_ATRIAS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c35_Walking_ATRIAS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c35_Walking_ATRIAS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c35_Walking_ATRIAS;
  chartInstance->chartInfo.mdlStart = mdlStart_c35_Walking_ATRIAS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c35_Walking_ATRIAS;
...
void c35_Walking_ATRIAS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c35_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c35_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c35_Walking_ATRIAS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c35_Walking_ATRIAS_method_dispatcher.\n"
