...
static void initialize_c38_Walking_ATRIAS(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance);
static void initialize_params_c38_Walking_ATRIAS
  (SFc38_Walking_ATRIASInstanceStruct *chartInstance);
static void enable_c38_Walking_ATRIAS(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance);
static void disable_c38_Walking_ATRIAS(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance);
static void c38_update_debugger_state_c38_Walking_ATRIAS
  (SFc38_Walking_ATRIASInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c38_Walking_ATRIAS
  (SFc38_Walking_ATRIASInstanceStruct *chartInstance);
static void set_sim_state_c38_Walking_ATRIAS(SFc38_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c38_st);
static void finalize_c38_Walking_ATRIAS(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance);
static void sf_gateway_c38_Walking_ATRIAS(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance);
static void mdl_start_c38_Walking_ATRIAS(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance);
static void initSimStructsc38_Walking_ATRIAS(SFc38_Walking_ATRIASInstanceStruct *
  chartInstance);
...
static const mxArray *c38_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static void c38_emlrt_marshallIn(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c38_b_Temperatures, const char_T
  *c38_identifier, real_T c38_y[30]);
static void c38_b_emlrt_marshallIn(SFc38_Walking_ATRIASInstanceStruct
...
static const mxArray *c38_b_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static real_T c38_c_emlrt_marshallIn(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
...
static const mxArray *c38_c_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static int32_T c38_d_emlrt_marshallIn(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
static void c38_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c38_mxArrayInData, const char_T *c38_varName, void *c38_outData);
static uint8_T c38_e_emlrt_marshallIn(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c38_b_is_active_c38_Walking_ATRIAS, const
  char_T *c38_identifier);
static uint8_T c38_f_emlrt_marshallIn(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
static void init_dsm_address_info(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc38_Walking_ATRIASInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c38_is_active_c38_Walking_ATRIAS = 0U;
}
  ...
  (SFc38_Walking_ATRIASInstanceStruct *chartInstance)
{
  ...
  c38_hoistedGlobal = chartInstance->c38_is_active_c38_Walking_ATRIAS;
  ...
  chartInstance, const mxArray *c38_st)
{
  ...
  chartInstance->c38_is_active_c38_Walking_ATRIAS = c38_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c38_u, 1)),
     "is_active_c38_Walking_ATRIAS");
  sf_mex_destroy(&c38_u);
  c38_update_debugger_state_c38_Walking_ATRIAS(chartInstance);
  ...
  *c38_inData)
{
  ...
  const mxArray *c38_y = NULL;
  SFc38_Walking_ATRIASInstanceStruct *chartInstance;
  chartInstance = (SFc38_Walking_ATRIASInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c38_Walking_ATRIAS_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c38_identifier)
{
  ...
  c38_y = c38_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c38_b_is_active_c38_Walking_ATRIAS), &c38_thisId);
  sf_mex_destroy(&c38_b_is_active_c38_Walking_ATRIAS);
  return c38_y;
}
...
void sf_c38_Walking_ATRIAS_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c38_Walking_ATRIAS_get_post_codegen_info(void);
mxArray *sf_c38_Walking_ATRIAS_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c38_Walking_ATRIAS_get_post_codegen_info();
...
mxArray *sf_c38_Walking_ATRIAS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c38_Walking_ATRIAS_jit_fallback_info(void)
{
...
mxArray *sf_c38_Walking_ATRIAS_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c38_Walking_ATRIAS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"Temperatures\",},{M[8],M[0],T\"is_active_c38_Walking_ATRIAS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c38_Walking_ATRIAS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc38_Walking_ATRIASInstanceStruct *)
...
static void sf_opaque_initialize_c38_Walking_ATRIAS(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc38_Walking_ATRIASInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
  initialize_c38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c38_Walking_ATRIAS(void *chartInstanceVar)
{
  enable_c38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c38_Walking_ATRIAS(void *chartInstanceVar)
{
  disable_c38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c38_Walking_ATRIAS(void *chartInstanceVar)
{
  sf_gateway_c38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c38_Walking_ATRIAS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c38_Walking_ATRIAS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c38_Walking_ATRIAS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc38_Walking_ATRIASInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc38_Walking_ATRIAS((SFc38_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c38_Walking_ATRIAS(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c38_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c38_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c38_Walking_ATRIAS(SimStruct *S)
{
  SFc38_Walking_ATRIASInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc38_Walking_ATRIASInstanceStruct *)utMalloc(sizeof
    (SFc38_Walking_ATRIASInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc38_Walking_ATRIASInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c38_Walking_ATRIAS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c38_Walking_ATRIAS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c38_Walking_ATRIAS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c38_Walking_ATRIAS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c38_Walking_ATRIAS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c38_Walking_ATRIAS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c38_Walking_ATRIAS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c38_Walking_ATRIAS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c38_Walking_ATRIAS;
  chartInstance->chartInfo.mdlStart = mdlStart_c38_Walking_ATRIAS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c38_Walking_ATRIAS;
...
void c38_Walking_ATRIAS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c38_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c38_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c38_Walking_ATRIAS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c38_Walking_ATRIAS_method_dispatcher.\n"
