...
static void initialize_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance);
static void initialize_params_c43_Walking_ATRIAS
  (SFc43_Walking_ATRIASInstanceStruct *chartInstance);
static void enable_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance);
static void disable_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance);
static void c43_update_debugger_state_c43_Walking_ATRIAS
  (SFc43_Walking_ATRIASInstanceStruct *chartInstance);
static void ext_mode_exec_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c43_Walking_ATRIAS
  (SFc43_Walking_ATRIASInstanceStruct *chartInstance);
static void set_sim_state_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c43_st);
static void c43_set_sim_state_side_effects_c43_Walking_ATRIAS
  (SFc43_Walking_ATRIASInstanceStruct *chartInstance);
static void finalize_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance);
static void sf_gateway_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance);
static void mdl_start_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance);
static void c43_chartstep_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct *
  chartInstance);
static void initSimStructsc43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct *
  chartInstance);
static void c43_Initialization(SFc43_Walking_ATRIASInstanceStruct *chartInstance);
static void c43_exit_internal_Initialization(SFc43_Walking_ATRIASInstanceStruct *
  chartInstance);
...
static const mxArray *c43_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static real_T c43_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c43_nargout, const char_T *c43_identifier);
static real_T c43_b_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct
...
static const mxArray *c43_b_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static boolean_T c43_c_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
...
static const mxArray *c43_c_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static int32_T c43_d_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
...
static const mxArray *c43_d_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static uint8_T c43_e_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c43_b_is_Initialization, const char_T
  *c43_identifier);
static uint8_T c43_f_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
static void c43_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c43_mxArrayInData, const char_T *c43_varName, void *c43_outData);
static void c43_g_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c43_b_dataWrittenToVector, const char_T
  *c43_identifier, boolean_T c43_y[4]);
static void c43_h_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId,
  boolean_T c43_y[4]);
static const mxArray *c43_i_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c43_b_setSimStateSideEffectsInfo, const char_T
  *c43_identifier);
static const mxArray *c43_j_emlrt_marshallIn(SFc43_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
static void c43_updateDataWrittenToVector(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance, uint32_T c43_vectorIndex);
static void c43_errorIfDataNotWrittenToFcn(SFc43_Walking_ATRIASInstanceStruct
...
static void init_dsm_address_info(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c43_is_active_c43_Walking_ATRIAS = 0U;
  *chartInstance->c43_is_c43_Walking_ATRIAS = c43_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc43_Walking_ATRIASInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c43_is_c43_Walking_ATRIAS == c43_IN_FaultRunning) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c43_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c43_sfEvent);
  }

  if (*chartInstance->c43_is_c43_Walking_ATRIAS == c43_IN_Running) {
...
static void ext_mode_exec_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct *
  chartInstance)
{
  c43_update_debugger_state_c43_Walking_ATRIAS(chartInstance);
}
  ...
  (SFc43_Walking_ATRIASInstanceStruct *chartInstance)
{
  ...
  c43_e_hoistedGlobal = *chartInstance->c43_is_active_c43_Walking_ATRIAS;
  ...
  c43_f_hoistedGlobal = *chartInstance->c43_is_c43_Walking_ATRIAS;
  ...
  chartInstance, const mxArray *c43_st)
{
  ...
  *chartInstance->c43_is_active_c43_Walking_ATRIAS = c43_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c43_u, 4)),
     "is_active_c43_Walking_ATRIAS");
  *chartInstance->c43_is_c43_Walking_ATRIAS = c43_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c43_u, 5)),
     "is_c43_Walking_ATRIAS");
...
static void sf_gateway_c43_Walking_ATRIAS(SFc43_Walking_ATRIASInstanceStruct
  *chartInstance)
{
  c43_set_sim_state_side_effects_c43_Walking_ATRIAS(chartInstance);
  ...
  *chartInstance->c43_sfEvent = CALL_EVENT;
  c43_chartstep_c43_Walking_ATRIAS(chartInstance);
  ...
  chartInstance)
{
  ...
  if (*chartInstance->c43_is_active_c43_Walking_ATRIAS == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 9U, *chartInstance->c43_sfEvent);
    *chartInstance->c43_is_active_c43_Walking_ATRIAS = 1U;
    ...
    *chartInstance->c43_is_c43_Walking_ATRIAS = c43_IN_Start1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c43_sfEvent);
    ...
    *chartInstance->c43_FaultDetected = 0.0;
    ...
    switch (*chartInstance->c43_is_c43_Walking_ATRIAS) {
     ...
     case c43_IN_Running:
      ...
      if (c43_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c43_sfEvent);
        *chartInstance->c43_is_c43_Walking_ATRIAS = c43_IN_FaultRunning;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c43_sfEvent);
     ...
     case c43_IN_Start1:
      ...
      if (c43_d_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c43_sfEvent);
        *chartInstance->c43_is_c43_Walking_ATRIAS = c43_IN_Initialization;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c43_sfEvent);
          ...
          *chartInstance->c43_FaultDetected = 0.0;
          ...
          if (c43_f_out) {
            ...
            *chartInstance->c43_is_Initialization = c43_IN_NO_ACTIVE_CHILD;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c43_sfEvent);
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c43_sfEvent);
            *chartInstance->c43_is_c43_Walking_ATRIAS = c43_IN_Running;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c43_sfEvent);
  ...
  *c43_inData)
{
  ...
  const mxArray *c43_y = NULL;
  SFc43_Walking_ATRIASInstanceStruct *chartInstance;
  chartInstance = (SFc43_Walking_ATRIASInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c43_Walking_ATRIAS_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c43_isStable = (boolean_T *)ssGetDWork_wrapper(chartInstance->S,
    1);
  chartInstance->c43_is_active_c43_Walking_ATRIAS = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 2);
  chartInstance->c43_is_c43_Walking_ATRIAS = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 3);
...
void sf_c43_Walking_ATRIAS_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c43_Walking_ATRIAS_get_post_codegen_info(void);
mxArray *sf_c43_Walking_ATRIAS_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c43_Walking_ATRIAS_get_post_codegen_info();
...
mxArray *sf_c43_Walking_ATRIAS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c43_Walking_ATRIAS_jit_fallback_info(void)
{
...
mxArray *sf_c43_Walking_ATRIAS_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c43_Walking_ATRIAS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[23],T\"ControlWordIndex\",},{M[1],M[24],T\"EnableTargetTorque\",},{M[1],M[64],T\"FaultDetected\",},{M[3],M[25],T\"Timeout\",},{M[8],M[0],T\"is_active_c43_Walking_ATRIAS\",},{M[9],M[0],T\"is_c43_Walking_ATRIAS\",},{M[9],M[87],T\"is_Initialization\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c43_Walking_ATRIAS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc43_Walking_ATRIASInstanceStruct *)
...
static void sf_opaque_initialize_c43_Walking_ATRIAS(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
  initialize_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c43_Walking_ATRIAS(void *chartInstanceVar)
{
  enable_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c43_Walking_ATRIAS(void *chartInstanceVar)
{
  disable_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c43_Walking_ATRIAS(void *chartInstanceVar)
{
  sf_gateway_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c43_Walking_ATRIAS(void *chartInstanceVar)
{
  ext_mode_exec_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c43_Walking_ATRIAS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c43_Walking_ATRIAS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c43_Walking_ATRIAS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc43_Walking_ATRIASInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc43_Walking_ATRIAS((SFc43_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c43_Walking_ATRIAS(SimStruct *S)
{
  int i;
...
mxArray *sf_c43_Walking_ATRIAS_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c43_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Walking_ATRIAS_optimization_info();
...
static void mdlRTW_c43_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c43_Walking_ATRIAS(SimStruct *S)
{
  SFc43_Walking_ATRIASInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc43_Walking_ATRIASInstanceStruct *)utMalloc(sizeof
    (SFc43_Walking_ATRIASInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc43_Walking_ATRIASInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c43_Walking_ATRIAS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c43_Walking_ATRIAS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c43_Walking_ATRIAS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c43_Walking_ATRIAS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c43_Walking_ATRIAS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c43_Walking_ATRIAS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c43_Walking_ATRIAS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c43_Walking_ATRIAS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c43_Walking_ATRIAS;
  chartInstance->chartInfo.mdlStart = mdlStart_c43_Walking_ATRIAS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c43_Walking_ATRIAS;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c43_Walking_ATRIAS;
...
void c43_Walking_ATRIAS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c43_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c43_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c43_Walking_ATRIAS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c43_Walking_ATRIAS_method_dispatcher.\n"
