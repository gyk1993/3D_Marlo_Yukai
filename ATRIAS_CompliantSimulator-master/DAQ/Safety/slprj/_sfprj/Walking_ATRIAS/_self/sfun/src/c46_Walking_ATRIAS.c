...
static const char * c46_gb_debug_family_names[3] = { "nargin", "nargout",
  "sf_internal_predicateOutput" };

static const char * c46_hb_debug_family_names[3] = { "nargin", "nargout",
  "sf_internal_predicateOutput" };

/* Function Declarations */
static void initialize_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance);
static void initialize_params_c46_Walking_ATRIAS
  (SFc46_Walking_ATRIASInstanceStruct *chartInstance);
static void enable_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance);
static void disable_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance);
static void c46_update_debugger_state_c46_Walking_ATRIAS
  (SFc46_Walking_ATRIASInstanceStruct *chartInstance);
static void ext_mode_exec_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c46_Walking_ATRIAS
  (SFc46_Walking_ATRIASInstanceStruct *chartInstance);
static void set_sim_state_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c46_st);
static void c46_set_sim_state_side_effects_c46_Walking_ATRIAS
  (SFc46_Walking_ATRIASInstanceStruct *chartInstance);
static void finalize_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance);
static void sf_gateway_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance);
static void mdl_start_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance);
static void c46_chartstep_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct *
  chartInstance);
static void initSimStructsc46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct *
  chartInstance);
static void c46_Initialization(SFc46_Walking_ATRIASInstanceStruct *chartInstance);
static void c46_exit_internal_Initialization(SFc46_Walking_ATRIASInstanceStruct *
  chartInstance);
...
static const mxArray *c46_sf_marshallOut(void *chartInstanceVoid, void
  *c46_inData);
static real_T c46_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c46_nargout, const char_T *c46_identifier);
static real_T c46_b_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct
...
static const mxArray *c46_b_sf_marshallOut(void *chartInstanceVoid, void
  *c46_inData);
static boolean_T c46_c_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c46_u, const emlrtMsgIdentifier *c46_parentId);
...
static const mxArray *c46_c_sf_marshallOut(void *chartInstanceVoid, void
  *c46_inData);
static int32_T c46_d_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c46_u, const emlrtMsgIdentifier *c46_parentId);
...
static const mxArray *c46_d_sf_marshallOut(void *chartInstanceVoid, void
  *c46_inData);
static uint8_T c46_e_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c46_b_is_Initialization, const char_T
  *c46_identifier);
static uint8_T c46_f_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c46_u, const emlrtMsgIdentifier *c46_parentId);
static void c46_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c46_mxArrayInData, const char_T *c46_varName, void *c46_outData);
static void c46_g_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c46_b_dataWrittenToVector, const char_T
  *c46_identifier, boolean_T c46_y[4]);
static void c46_h_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance, const mxArray *c46_u, const emlrtMsgIdentifier *c46_parentId,
  boolean_T c46_y[4]);
static const mxArray *c46_i_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c46_b_setSimStateSideEffectsInfo, const char_T
  *c46_identifier);
static const mxArray *c46_j_emlrt_marshallIn(SFc46_Walking_ATRIASInstanceStruct *
  chartInstance, const mxArray *c46_u, const emlrtMsgIdentifier *c46_parentId);
static void c46_updateDataWrittenToVector(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance, uint32_T c46_vectorIndex);
static void c46_errorIfDataNotWrittenToFcn(SFc46_Walking_ATRIASInstanceStruct
...
static void init_dsm_address_info(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c46_is_active_c46_Walking_ATRIAS = 0U;
  *chartInstance->c46_is_c46_Walking_ATRIAS = c46_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc46_Walking_ATRIASInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c46_is_active_c46_Walking_ATRIAS == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 12U, *chartInstance->c46_sfEvent);
  }

  if (*chartInstance->c46_is_c46_Walking_ATRIAS == c46_IN_Start1) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c46_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c46_sfEvent);
  }

  if (*chartInstance->c46_is_c46_Walking_ATRIAS == c46_IN_Initialization) {
  ...
  if (*chartInstance->c46_is_c46_Walking_ATRIAS == c46_IN_FaultRunning) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c46_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c46_sfEvent);
  }

  if (*chartInstance->c46_is_c46_Walking_ATRIAS == c46_IN_Running) {
...
static void ext_mode_exec_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct *
  chartInstance)
{
  c46_update_debugger_state_c46_Walking_ATRIAS(chartInstance);
}
  ...
  (SFc46_Walking_ATRIASInstanceStruct *chartInstance)
{
  ...
  c46_e_hoistedGlobal = *chartInstance->c46_is_active_c46_Walking_ATRIAS;
  ...
  c46_f_hoistedGlobal = *chartInstance->c46_is_c46_Walking_ATRIAS;
  ...
  chartInstance, const mxArray *c46_st)
{
  ...
  *chartInstance->c46_is_active_c46_Walking_ATRIAS = c46_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c46_u, 4)),
     "is_active_c46_Walking_ATRIAS");
  *chartInstance->c46_is_c46_Walking_ATRIAS = c46_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c46_u, 5)),
     "is_c46_Walking_ATRIAS");
...
static void sf_gateway_c46_Walking_ATRIAS(SFc46_Walking_ATRIASInstanceStruct
  *chartInstance)
{
  c46_set_sim_state_side_effects_c46_Walking_ATRIAS(chartInstance);
  ...
  *chartInstance->c46_sfEvent = CALL_EVENT;
  c46_chartstep_c46_Walking_ATRIAS(chartInstance);
  ...
  chartInstance)
{
  ...
  if (*chartInstance->c46_is_active_c46_Walking_ATRIAS == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 12U,
                 *chartInstance->c46_sfEvent);
    *chartInstance->c46_is_active_c46_Walking_ATRIAS = 1U;
    ...
    *chartInstance->c46_is_c46_Walking_ATRIAS = c46_IN_Start1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c46_sfEvent);
    ...
    *chartInstance->c46_FaultDetected = 0.0;
    ...
    switch (*chartInstance->c46_is_c46_Walking_ATRIAS) {
     case c46_IN_FaultRunning:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c46_out, 2U, c46_b_sf_marshallOut,
        c46_b_sf_marshallIn);
      c46_out = CV_EML_IF(13, 0, 0, CV_RELATIONAL_EVAL(5U, 13U, 0,
        *chartInstance->c46_MedullaCommand, 6.0, -1, 0U,
        *chartInstance->c46_MedullaCommand == 6.0));
      _SFD_SYMBOL_SCOPE_POP();
      if (c46_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 13U, *chartInstance->c46_sfEvent);
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c46_sfEvent);
        *chartInstance->c46_is_c46_Walking_ATRIAS = c46_IN_Start1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c46_sfEvent);
        _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 2U, 2U, c46_debug_family_names,
     ...
     case c46_IN_Running:
      ...
      _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 3U, 3U, c46_s_debug_family_names,
        c46_b_debug_family_var_map);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c46_d_nargin, 0U, c46_sf_marshallOut,
        c46_sf_marshallIn);
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c46_b_out, 2U, c46_b_sf_marshallOut,
        c46_b_sf_marshallIn);
      c46_b_out = CV_EML_IF(1, 0, 0, CV_RELATIONAL_EVAL(5U, 1U, 0, (real_T)
      ...
      if (c46_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c46_sfEvent);
        *chartInstance->c46_is_c46_Walking_ATRIAS = c46_IN_FaultRunning;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c46_sfEvent);
     ...
     case c46_IN_Start1:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c46_d_out, 2U, c46_b_sf_marshallOut,
        c46_b_sf_marshallIn);
      c46_d_out = CV_EML_IF(5, 0, 0, CV_RELATIONAL_EVAL(5U, 5U, 0,
      ...
      if (c46_d_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c46_sfEvent);
        *chartInstance->c46_is_c46_Walking_ATRIAS = c46_IN_Initialization;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c46_sfEvent);
        ...
        if (c46_e_out) {
          ...
          *chartInstance->c46_FaultDetected = 0.0;
          ...
          _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 8U,
                       *chartInstance->c46_sfEvent);
          _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 3U, 3U, c46_u_debug_family_names,
            c46_debug_family_var_map);
          ...
          if (c46_f_out) {
            ...
            *chartInstance->c46_is_Initialization = c46_IN_NO_ACTIVE_CHILD;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c46_sfEvent);
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c46_sfEvent);
            *chartInstance->c46_is_c46_Walking_ATRIAS = c46_IN_Running;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c46_sfEvent);
  ...
  *c46_inData)
{
  ...
  const mxArray *c46_y = NULL;
  SFc46_Walking_ATRIASInstanceStruct *chartInstance;
  chartInstance = (SFc46_Walking_ATRIASInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c46_Walking_ATRIAS_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c46_isStable = (boolean_T *)ssGetDWork_wrapper(chartInstance->S,
    1);
  chartInstance->c46_is_active_c46_Walking_ATRIAS = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 2);
  chartInstance->c46_is_c46_Walking_ATRIAS = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 3);
...
void sf_c46_Walking_ATRIAS_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c46_Walking_ATRIAS_get_post_codegen_info(void);
mxArray *sf_c46_Walking_ATRIAS_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c46_Walking_ATRIAS_get_post_codegen_info();
...
mxArray *sf_c46_Walking_ATRIAS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c46_Walking_ATRIAS_jit_fallback_info(void)
{
...
mxArray *sf_c46_Walking_ATRIAS_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c46_Walking_ATRIAS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[23],T\"ControlWordIndex\",},{M[1],M[24],T\"EnableTargetTorque\",},{M[1],M[64],T\"FaultDetected\",},{M[3],M[25],T\"Timeout\",},{M[8],M[0],T\"is_active_c46_Walking_ATRIAS\",},{M[9],M[0],T\"is_c46_Walking_ATRIAS\",},{M[9],M[168],T\"is_Initialization\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c46_Walking_ATRIAS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc46_Walking_ATRIASInstanceStruct *)
...
static void sf_opaque_initialize_c46_Walking_ATRIAS(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
  initialize_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c46_Walking_ATRIAS(void *chartInstanceVar)
{
  enable_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c46_Walking_ATRIAS(void *chartInstanceVar)
{
  disable_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c46_Walking_ATRIAS(void *chartInstanceVar)
{
  sf_gateway_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c46_Walking_ATRIAS(void *chartInstanceVar)
{
  ext_mode_exec_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c46_Walking_ATRIAS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c46_Walking_ATRIAS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c46_Walking_ATRIAS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc46_Walking_ATRIASInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc46_Walking_ATRIAS((SFc46_Walking_ATRIASInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c46_Walking_ATRIAS(SimStruct *S)
{
  int i;
...
mxArray *sf_c46_Walking_ATRIAS_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c46_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Walking_ATRIAS_optimization_info();
...
static void mdlRTW_c46_Walking_ATRIAS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c46_Walking_ATRIAS(SimStruct *S)
{
  SFc46_Walking_ATRIASInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc46_Walking_ATRIASInstanceStruct *)utMalloc(sizeof
    (SFc46_Walking_ATRIASInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc46_Walking_ATRIASInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c46_Walking_ATRIAS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c46_Walking_ATRIAS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c46_Walking_ATRIAS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c46_Walking_ATRIAS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c46_Walking_ATRIAS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c46_Walking_ATRIAS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c46_Walking_ATRIAS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c46_Walking_ATRIAS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c46_Walking_ATRIAS;
  chartInstance->chartInfo.mdlStart = mdlStart_c46_Walking_ATRIAS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c46_Walking_ATRIAS;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c46_Walking_ATRIAS;
...
void c46_Walking_ATRIAS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c46_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c46_Walking_ATRIAS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c46_Walking_ATRIAS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c46_Walking_ATRIAS_method_dispatcher.\n"
