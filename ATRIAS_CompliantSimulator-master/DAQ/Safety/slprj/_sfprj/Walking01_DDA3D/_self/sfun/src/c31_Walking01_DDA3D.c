...
static void initialize_c31_Walking01_DDA3D(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initialize_params_c31_Walking01_DDA3D
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance);
static void enable_c31_Walking01_DDA3D(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void disable_c31_Walking01_DDA3D(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c31_update_debugger_state_c31_Walking01_DDA3D
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c31_Walking01_DDA3D
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance);
static void set_sim_state_c31_Walking01_DDA3D
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance, const mxArray *c31_st);
static void finalize_c31_Walking01_DDA3D(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void sf_gateway_c31_Walking01_DDA3D(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void mdl_start_c31_Walking01_DDA3D(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c31_chartstep_c31_Walking01_DDA3D
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance);
static void initSimStructsc31_Walking01_DDA3D
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance);
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_emlrt_marshallIn(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c31_b_q, const char_T *c31_identifier, real_T
  c31_y[13]);
static void c31_b_emlrt_marshallIn(SFc31_Walking01_DDA3DInstanceStruct
...
static const mxArray *c31_c_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_c_emlrt_marshallIn(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
...
static void c31_realmax(SFc31_Walking01_DDA3DInstanceStruct *chartInstance);
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_d_emlrt_marshallIn(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static uint8_T c31_e_emlrt_marshallIn(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c31_b_is_active_c31_Walking01_DDA3D, const
  char_T *c31_identifier);
static uint8_T c31_f_emlrt_marshallIn(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void init_dsm_address_info(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc31_Walking01_DDA3DInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c31_is_active_c31_Walking01_DDA3D = 0U;
}
  ...
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  c31_hoistedGlobal = chartInstance->c31_is_active_c31_Walking01_DDA3D;
  ...
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance, const mxArray *c31_st)
{
  ...
  chartInstance->c31_is_active_c31_Walking01_DDA3D = c31_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 1)),
     "is_active_c31_Walking01_DDA3D");
  sf_mex_destroy(&c31_u);
  c31_update_debugger_state_c31_Walking01_DDA3D(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c31_sfEvent);
  for (c31_i2 = 0; c31_i2 < 13; c31_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c31_q_in)[c31_i2], 0U);
  }

  chartInstance->c31_sfEvent = CALL_EVENT;
  c31_chartstep_c31_Walking01_DDA3D(chartInstance);
  ...
  (SFc31_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  int32_T c31_i9;
  int32_T c31_i10;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c31_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c31_sfEvent);
}
  ...
  *c31_inData)
{
  ...
  const mxArray *c31_y = NULL;
  SFc31_Walking01_DDA3DInstanceStruct *chartInstance;
  chartInstance = (SFc31_Walking01_DDA3DInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c31_Walking01_DDA3D_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c31_identifier)
{
  ...
  c31_y = c31_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c31_b_is_active_c31_Walking01_DDA3D), &c31_thisId);
  sf_mex_destroy(&c31_b_is_active_c31_Walking01_DDA3D);
  return c31_y;
}
...
void sf_c31_Walking01_DDA3D_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c31_Walking01_DDA3D_get_post_codegen_info(void);
mxArray *sf_c31_Walking01_DDA3D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c31_Walking01_DDA3D_get_post_codegen_info();
...
mxArray *sf_c31_Walking01_DDA3D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c31_Walking01_DDA3D_jit_fallback_info(void)
{
...
mxArray *sf_c31_Walking01_DDA3D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c31_Walking01_DDA3D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"q\",},{M[8],M[0],T\"is_active_c31_Walking01_DDA3D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_Walking01_DDA3D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc31_Walking01_DDA3DInstanceStruct *)
...
static void sf_opaque_initialize_c31_Walking01_DDA3D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
  initialize_c31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c31_Walking01_DDA3D(void *chartInstanceVar)
{
  enable_c31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c31_Walking01_DDA3D(void *chartInstanceVar)
{
  disable_c31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c31_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_gateway_c31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c31_Walking01_DDA3D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c31_Walking01_DDA3D(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c31_Walking01_DDA3D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_Walking01_DDA3DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc31_Walking01_DDA3D((SFc31_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_Walking01_DDA3D(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c31_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c31_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_Walking01_DDA3D(SimStruct *S)
{
  SFc31_Walking01_DDA3DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc31_Walking01_DDA3DInstanceStruct *)utMalloc(sizeof
    (SFc31_Walking01_DDA3DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc31_Walking01_DDA3DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c31_Walking01_DDA3D;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c31_Walking01_DDA3D;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c31_Walking01_DDA3D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c31_Walking01_DDA3D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c31_Walking01_DDA3D;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c31_Walking01_DDA3D;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c31_Walking01_DDA3D;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c31_Walking01_DDA3D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_Walking01_DDA3D;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_Walking01_DDA3D;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c31_Walking01_DDA3D;
...
void c31_Walking01_DDA3D_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_Walking01_DDA3D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_Walking01_DDA3D_method_dispatcher.\n"
