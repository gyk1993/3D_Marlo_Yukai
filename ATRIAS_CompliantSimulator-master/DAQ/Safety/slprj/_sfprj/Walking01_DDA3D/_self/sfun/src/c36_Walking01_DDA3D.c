...
static void initialize_c36_Walking01_DDA3D(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initialize_params_c36_Walking01_DDA3D
  (SFc36_Walking01_DDA3DInstanceStruct *chartInstance);
static void enable_c36_Walking01_DDA3D(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void disable_c36_Walking01_DDA3D(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c36_update_debugger_state_c36_Walking01_DDA3D
  (SFc36_Walking01_DDA3DInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c36_Walking01_DDA3D
  (SFc36_Walking01_DDA3DInstanceStruct *chartInstance);
static void set_sim_state_c36_Walking01_DDA3D
  (SFc36_Walking01_DDA3DInstanceStruct *chartInstance, const mxArray *c36_st);
static void finalize_c36_Walking01_DDA3D(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void sf_gateway_c36_Walking01_DDA3D(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void mdl_start_c36_Walking01_DDA3D(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initSimStructsc36_Walking01_DDA3D
  (SFc36_Walking01_DDA3DInstanceStruct *chartInstance);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c36_b_logicVoltage, const char_T
  *c36_identifier, real_T c36_y[6]);
static void c36_b_emlrt_marshallIn(SFc36_Walking01_DDA3DInstanceStruct
...
static const mxArray *c36_b_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_c_emlrt_marshallIn(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_d_emlrt_marshallIn(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_e_emlrt_marshallIn(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c36_b_is_active_c36_Walking01_DDA3D, const
  char_T *c36_identifier);
static uint8_T c36_f_emlrt_marshallIn(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc36_Walking01_DDA3DInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_Walking01_DDA3D = 0U;
}
  ...
  (SFc36_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_Walking01_DDA3D;
  ...
  (SFc36_Walking01_DDA3DInstanceStruct *chartInstance, const mxArray *c36_st)
{
  ...
  chartInstance->c36_is_active_c36_Walking01_DDA3D = c36_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 1)),
     "is_active_c36_Walking01_DDA3D");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_Walking01_DDA3D(chartInstance);
  ...
  *c36_inData)
{
  ...
  const mxArray *c36_y = NULL;
  SFc36_Walking01_DDA3DInstanceStruct *chartInstance;
  chartInstance = (SFc36_Walking01_DDA3DInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c36_Walking01_DDA3D_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c36_identifier)
{
  ...
  c36_y = c36_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_Walking01_DDA3D), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_Walking01_DDA3D);
  return c36_y;
}
...
void sf_c36_Walking01_DDA3D_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c36_Walking01_DDA3D_get_post_codegen_info(void);
mxArray *sf_c36_Walking01_DDA3D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c36_Walking01_DDA3D_get_post_codegen_info();
...
mxArray *sf_c36_Walking01_DDA3D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c36_Walking01_DDA3D_jit_fallback_info(void)
{
...
mxArray *sf_c36_Walking01_DDA3D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c36_Walking01_DDA3D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"logicVoltage\",},{M[8],M[0],T\"is_active_c36_Walking01_DDA3D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_Walking01_DDA3D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc36_Walking01_DDA3DInstanceStruct *)
...
static void sf_opaque_initialize_c36_Walking01_DDA3D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
  initialize_c36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c36_Walking01_DDA3D(void *chartInstanceVar)
{
  enable_c36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c36_Walking01_DDA3D(void *chartInstanceVar)
{
  disable_c36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c36_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_gateway_c36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c36_Walking01_DDA3D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c36_Walking01_DDA3D(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c36_Walking01_DDA3D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_Walking01_DDA3DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc36_Walking01_DDA3D((SFc36_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_Walking01_DDA3D(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c36_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c36_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c36_Walking01_DDA3D(SimStruct *S)
{
  SFc36_Walking01_DDA3DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc36_Walking01_DDA3DInstanceStruct *)utMalloc(sizeof
    (SFc36_Walking01_DDA3DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_Walking01_DDA3DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c36_Walking01_DDA3D;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c36_Walking01_DDA3D;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c36_Walking01_DDA3D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c36_Walking01_DDA3D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c36_Walking01_DDA3D;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c36_Walking01_DDA3D;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c36_Walking01_DDA3D;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c36_Walking01_DDA3D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_Walking01_DDA3D;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_Walking01_DDA3D;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c36_Walking01_DDA3D;
...
void c36_Walking01_DDA3D_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_Walking01_DDA3D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_Walking01_DDA3D_method_dispatcher.\n"
