...
static void initialize_c37_Walking01_DDA3D(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initialize_params_c37_Walking01_DDA3D
  (SFc37_Walking01_DDA3DInstanceStruct *chartInstance);
static void enable_c37_Walking01_DDA3D(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void disable_c37_Walking01_DDA3D(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c37_update_debugger_state_c37_Walking01_DDA3D
  (SFc37_Walking01_DDA3DInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c37_Walking01_DDA3D
  (SFc37_Walking01_DDA3DInstanceStruct *chartInstance);
static void set_sim_state_c37_Walking01_DDA3D
  (SFc37_Walking01_DDA3DInstanceStruct *chartInstance, const mxArray *c37_st);
static void finalize_c37_Walking01_DDA3D(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void sf_gateway_c37_Walking01_DDA3D(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void mdl_start_c37_Walking01_DDA3D(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initSimStructsc37_Walking01_DDA3D
  (SFc37_Walking01_DDA3DInstanceStruct *chartInstance);
...
static const mxArray *c37_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_emlrt_marshallIn(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c37_b_motorVoltage, const char_T
  *c37_identifier, real_T c37_y[6]);
static void c37_b_emlrt_marshallIn(SFc37_Walking01_DDA3DInstanceStruct
...
static const mxArray *c37_b_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static real_T c37_c_emlrt_marshallIn(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
...
static const mxArray *c37_c_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static int32_T c37_d_emlrt_marshallIn(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static uint8_T c37_e_emlrt_marshallIn(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c37_b_is_active_c37_Walking01_DDA3D, const
  char_T *c37_identifier);
static uint8_T c37_f_emlrt_marshallIn(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void init_dsm_address_info(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc37_Walking01_DDA3DInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c37_is_active_c37_Walking01_DDA3D = 0U;
}
  ...
  (SFc37_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  c37_hoistedGlobal = chartInstance->c37_is_active_c37_Walking01_DDA3D;
  ...
  (SFc37_Walking01_DDA3DInstanceStruct *chartInstance, const mxArray *c37_st)
{
  ...
  chartInstance->c37_is_active_c37_Walking01_DDA3D = c37_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c37_u, 1)),
     "is_active_c37_Walking01_DDA3D");
  sf_mex_destroy(&c37_u);
  c37_update_debugger_state_c37_Walking01_DDA3D(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 5U, chartInstance->c37_sfEvent);
  for (c37_i2 = 0; c37_i2 < 6; c37_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c37_adc_value)[c37_i2], 0U);
  }

  chartInstance->c37_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 5U, chartInstance->c37_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 5U, chartInstance->c37_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c37_inData)
{
  ...
  const mxArray *c37_y = NULL;
  SFc37_Walking01_DDA3DInstanceStruct *chartInstance;
  chartInstance = (SFc37_Walking01_DDA3DInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c37_Walking01_DDA3D_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c37_identifier)
{
  ...
  c37_y = c37_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c37_b_is_active_c37_Walking01_DDA3D), &c37_thisId);
  sf_mex_destroy(&c37_b_is_active_c37_Walking01_DDA3D);
  return c37_y;
}
...
void sf_c37_Walking01_DDA3D_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c37_Walking01_DDA3D_get_post_codegen_info(void);
mxArray *sf_c37_Walking01_DDA3D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c37_Walking01_DDA3D_get_post_codegen_info();
...
mxArray *sf_c37_Walking01_DDA3D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c37_Walking01_DDA3D_jit_fallback_info(void)
{
...
mxArray *sf_c37_Walking01_DDA3D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c37_Walking01_DDA3D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"motorVoltage\",},{M[8],M[0],T\"is_active_c37_Walking01_DDA3D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c37_Walking01_DDA3D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc37_Walking01_DDA3DInstanceStruct *)
...
static void sf_opaque_initialize_c37_Walking01_DDA3D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
  initialize_c37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c37_Walking01_DDA3D(void *chartInstanceVar)
{
  enable_c37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c37_Walking01_DDA3D(void *chartInstanceVar)
{
  disable_c37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c37_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_gateway_c37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c37_Walking01_DDA3D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c37_Walking01_DDA3D(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c37_Walking01_DDA3D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc37_Walking01_DDA3DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc37_Walking01_DDA3D((SFc37_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c37_Walking01_DDA3D(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c37_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c37_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c37_Walking01_DDA3D(SimStruct *S)
{
  SFc37_Walking01_DDA3DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc37_Walking01_DDA3DInstanceStruct *)utMalloc(sizeof
    (SFc37_Walking01_DDA3DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc37_Walking01_DDA3DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c37_Walking01_DDA3D;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c37_Walking01_DDA3D;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c37_Walking01_DDA3D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c37_Walking01_DDA3D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c37_Walking01_DDA3D;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c37_Walking01_DDA3D;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c37_Walking01_DDA3D;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c37_Walking01_DDA3D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c37_Walking01_DDA3D;
  chartInstance->chartInfo.mdlStart = mdlStart_c37_Walking01_DDA3D;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c37_Walking01_DDA3D;
...
void c37_Walking01_DDA3D_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c37_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c37_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c37_Walking01_DDA3D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c37_Walking01_DDA3D_method_dispatcher.\n"
