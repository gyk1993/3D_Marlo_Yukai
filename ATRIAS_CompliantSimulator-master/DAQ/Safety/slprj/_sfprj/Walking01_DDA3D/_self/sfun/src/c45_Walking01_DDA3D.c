...
static void initialize_c45_Walking01_DDA3D(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initialize_params_c45_Walking01_DDA3D
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance);
static void enable_c45_Walking01_DDA3D(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void disable_c45_Walking01_DDA3D(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c45_update_debugger_state_c45_Walking01_DDA3D
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance);
static void ext_mode_exec_c45_Walking01_DDA3D
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c45_Walking01_DDA3D
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance);
static void set_sim_state_c45_Walking01_DDA3D
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance, const mxArray *c45_st);
static void c45_set_sim_state_side_effects_c45_Walking01_DDA3D
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance);
static void finalize_c45_Walking01_DDA3D(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void sf_gateway_c45_Walking01_DDA3D(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void mdl_start_c45_Walking01_DDA3D(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initSimStructsc45_Walking01_DDA3D
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance);
static void c45_Initialization(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c45_exit_internal_Initialization(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
...
static const mxArray *c45_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static real_T c45_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_nargout, const char_T *c45_identifier);
static real_T c45_b_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
...
static const mxArray *c45_b_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static boolean_T c45_c_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
...
static const mxArray *c45_c_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static int32_T c45_d_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
...
static const mxArray *c45_d_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static uint8_T c45_e_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_b_is_Initialization, const char_T
  *c45_identifier);
static uint8_T c45_f_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
static void c45_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c45_mxArrayInData, const char_T *c45_varName, void *c45_outData);
static void c45_g_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_b_dataWrittenToVector, const char_T
  *c45_identifier, boolean_T c45_y[4]);
static void c45_h_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId,
  boolean_T c45_y[4]);
static const mxArray *c45_i_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_b_setSimStateSideEffectsInfo, const char_T *
  c45_identifier);
static const mxArray *c45_j_emlrt_marshallIn(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
static void c45_updateDataWrittenToVector(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance, uint32_T c45_vectorIndex);
static void c45_errorIfDataNotWrittenToFcn(SFc45_Walking01_DDA3DInstanceStruct
...
static void init_dsm_address_info(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc45_Walking01_DDA3DInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c45_is_active_c45_Walking01_DDA3D = 0U;
  *chartInstance->c45_is_c45_Walking01_DDA3D = c45_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c45_is_active_c45_Walking01_DDA3D == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 13U, *chartInstance->c45_sfEvent);
  }

  if (*chartInstance->c45_is_c45_Walking01_DDA3D == c45_IN_Start1) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c45_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c45_sfEvent);
  }

  if (*chartInstance->c45_is_c45_Walking01_DDA3D == c45_IN_Initialization) {
  ...
  if (*chartInstance->c45_is_c45_Walking01_DDA3D == c45_IN_FaultRunning) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c45_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c45_sfEvent);
  }

  if (*chartInstance->c45_is_c45_Walking01_DDA3D == c45_IN_Running) {
...
static void ext_mode_exec_c45_Walking01_DDA3D
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance)
{
  c45_update_debugger_state_c45_Walking01_DDA3D(chartInstance);
}
  ...
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  c45_e_hoistedGlobal = *chartInstance->c45_is_active_c45_Walking01_DDA3D;
  ...
  c45_f_hoistedGlobal = *chartInstance->c45_is_c45_Walking01_DDA3D;
  ...
  (SFc45_Walking01_DDA3DInstanceStruct *chartInstance, const mxArray *c45_st)
{
  ...
  *chartInstance->c45_is_active_c45_Walking01_DDA3D = c45_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c45_u, 4)),
     "is_active_c45_Walking01_DDA3D");
  *chartInstance->c45_is_c45_Walking01_DDA3D = c45_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c45_u, 5)),
     "is_c45_Walking01_DDA3D");
  ...
  *chartInstance)
{
  ...
  c45_set_sim_state_side_effects_c45_Walking01_DDA3D(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 13U, *chartInstance->c45_sfEvent);
  ...
  *chartInstance->c45_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 13U, *chartInstance->c45_sfEvent);
  if (*chartInstance->c45_is_active_c45_Walking01_DDA3D == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 13U,
                 *chartInstance->c45_sfEvent);
    *chartInstance->c45_is_active_c45_Walking01_DDA3D = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 13U, *chartInstance->c45_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 10U, *chartInstance->c45_sfEvent);
    *chartInstance->c45_is_c45_Walking01_DDA3D = c45_IN_Start1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c45_sfEvent);
    ...
    *chartInstance->c45_FaultDetected = 0.0;
    ...
    switch (*chartInstance->c45_is_c45_Walking01_DDA3D) {
     ...
     case c45_IN_Running:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c45_out, 2U, c45_b_sf_marshallOut,
        c45_b_sf_marshallIn);
      c45_out = CV_EML_IF(1, 0, 0, CV_RELATIONAL_EVAL(5U, 1U, 0, (real_T)
      ...
      if (c45_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c45_sfEvent);
        *chartInstance->c45_is_c45_Walking01_DDA3D = c45_IN_FaultRunning;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c45_sfEvent);
        ...
        *chartInstance->c45_FaultDetected = 1.0;
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c45_d_nargout, 1U,
          c45_sf_marshallOut, c45_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c45_b_out, 2U,
     ...
     case c45_IN_Start1:
      ...
      _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 3U, 3U, c45_p_debug_family_names,
        c45_b_debug_family_var_map);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c45_f_nargin, 0U, c45_sf_marshallOut,
        c45_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c45_f_nargout, 1U,
        c45_sf_marshallOut, c45_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c45_c_out, 2U, c45_b_sf_marshallOut,
        c45_b_sf_marshallIn);
      c45_c_out = CV_EML_IF(5, 0, 0, CV_RELATIONAL_EVAL(5U, 5U, 0,
      ...
      if (c45_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c45_sfEvent);
        *chartInstance->c45_is_c45_Walking01_DDA3D = c45_IN_Initialization;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c45_sfEvent);
          ...
          *chartInstance->c45_FaultDetected = 0.0;
          ...
          if (c45_f_out) {
            ...
            *chartInstance->c45_is_Initialization = c45_IN_NO_ACTIVE_CHILD;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c45_sfEvent);
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c45_sfEvent);
            *chartInstance->c45_is_c45_Walking01_DDA3D = c45_IN_Running;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c45_sfEvent);
  ...
  *c45_inData)
{
  ...
  const mxArray *c45_y = NULL;
  SFc45_Walking01_DDA3DInstanceStruct *chartInstance;
  chartInstance = (SFc45_Walking01_DDA3DInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c45_Walking01_DDA3D_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c45_isStable = (boolean_T *)ssGetDWork_wrapper(chartInstance->S,
    1);
  chartInstance->c45_is_active_c45_Walking01_DDA3D = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 2);
  chartInstance->c45_is_c45_Walking01_DDA3D = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 3);
...
void sf_c45_Walking01_DDA3D_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c45_Walking01_DDA3D_get_post_codegen_info(void);
mxArray *sf_c45_Walking01_DDA3D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c45_Walking01_DDA3D_get_post_codegen_info();
...
mxArray *sf_c45_Walking01_DDA3D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c45_Walking01_DDA3D_jit_fallback_info(void)
{
...
mxArray *sf_c45_Walking01_DDA3D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c45_Walking01_DDA3D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[23],T\"ControlWordIndex\",},{M[1],M[24],T\"EnableTargetTorque\",},{M[1],M[64],T\"FaultDetected\",},{M[3],M[25],T\"Timeout\",},{M[8],M[0],T\"is_active_c45_Walking01_DDA3D\",},{M[9],M[0],T\"is_c45_Walking01_DDA3D\",},{M[9],M[144],T\"is_Initialization\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c45_Walking01_DDA3D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc45_Walking01_DDA3DInstanceStruct *)
...
static void sf_opaque_initialize_c45_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
  initialize_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c45_Walking01_DDA3D(void *chartInstanceVar)
{
  enable_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c45_Walking01_DDA3D(void *chartInstanceVar)
{
  disable_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c45_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_gateway_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c45_Walking01_DDA3D(void *chartInstanceVar)
{
  ext_mode_exec_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c45_Walking01_DDA3D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c45_Walking01_DDA3D(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c45_Walking01_DDA3D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc45_Walking01_DDA3DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc45_Walking01_DDA3D((SFc45_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c45_Walking01_DDA3D(SimStruct *S)
{
  int i;
...
mxArray *sf_c45_Walking01_DDA3D_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c45_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Walking01_DDA3D_optimization_info();
...
static void mdlRTW_c45_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c45_Walking01_DDA3D(SimStruct *S)
{
  SFc45_Walking01_DDA3DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc45_Walking01_DDA3DInstanceStruct *)utMalloc(sizeof
    (SFc45_Walking01_DDA3DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc45_Walking01_DDA3DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c45_Walking01_DDA3D;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c45_Walking01_DDA3D;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c45_Walking01_DDA3D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c45_Walking01_DDA3D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c45_Walking01_DDA3D;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c45_Walking01_DDA3D;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c45_Walking01_DDA3D;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c45_Walking01_DDA3D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c45_Walking01_DDA3D;
  chartInstance->chartInfo.mdlStart = mdlStart_c45_Walking01_DDA3D;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c45_Walking01_DDA3D;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c45_Walking01_DDA3D;
...
void c45_Walking01_DDA3D_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c45_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c45_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c45_Walking01_DDA3D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c45_Walking01_DDA3D_method_dispatcher.\n"
