...
static void initialize_c1_Walking01_DDA3D(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initialize_params_c1_Walking01_DDA3D
  (SFc1_Walking01_DDA3DInstanceStruct *chartInstance);
static void enable_c1_Walking01_DDA3D(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void disable_c1_Walking01_DDA3D(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_Walking01_DDA3D
  (SFc1_Walking01_DDA3DInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Walking01_DDA3D
  (SFc1_Walking01_DDA3DInstanceStruct *chartInstance);
static void set_sim_state_c1_Walking01_DDA3D(SFc1_Walking01_DDA3DInstanceStruct *
  chartInstance, const mxArray *c1_st);
static void finalize_c1_Walking01_DDA3D(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void sf_gateway_c1_Walking01_DDA3D(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void mdl_start_c1_Walking01_DDA3D(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initSimStructsc1_Walking01_DDA3D(SFc1_Walking01_DDA3DInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c1_b_y, const char_T *c1_identifier, real_T
  c1_c_y[3]);
static void c1_b_emlrt_marshallIn(SFc1_Walking01_DDA3DInstanceStruct
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId,
  real32_T c1_b_y[3]);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_f_emlrt_marshallIn(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_Walking01_DDA3D, const char_T
  *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc1_Walking01_DDA3DInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Walking01_DDA3D = 0U;
}
  ...
  (SFc1_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_Walking01_DDA3D;
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_Walking01_DDA3D = c1_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_b_u, 1)),
     "is_active_c1_Walking01_DDA3D");
  sf_mex_destroy(&c1_b_u);
  c1_update_debugger_state_c1_Walking01_DDA3D(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_Walking01_DDA3DInstanceStruct *chartInstance;
  chartInstance = (SFc1_Walking01_DDA3DInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_Walking01_DDA3D_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_b_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Walking01_DDA3D), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Walking01_DDA3D);
  return c1_b_y;
}
...
void sf_c1_Walking01_DDA3D_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_Walking01_DDA3D_get_post_codegen_info(void);
mxArray *sf_c1_Walking01_DDA3D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_Walking01_DDA3D_get_post_codegen_info();
...
mxArray *sf_c1_Walking01_DDA3D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Walking01_DDA3D_jit_fallback_info(void)
{
...
mxArray *sf_c1_Walking01_DDA3D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_Walking01_DDA3D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_Walking01_DDA3D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Walking01_DDA3D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_Walking01_DDA3DInstanceStruct *)
...
static void sf_opaque_initialize_c1_Walking01_DDA3D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
  initialize_c1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_Walking01_DDA3D(void *chartInstanceVar)
{
  enable_c1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_Walking01_DDA3D(void *chartInstanceVar)
{
  disable_c1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_gateway_c1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_Walking01_DDA3D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_Walking01_DDA3D(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c1_Walking01_DDA3D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Walking01_DDA3DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_Walking01_DDA3D((SFc1_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Walking01_DDA3D(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Walking01_DDA3D(SimStruct *S)
{
  SFc1_Walking01_DDA3DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Walking01_DDA3DInstanceStruct *)utMalloc(sizeof
    (SFc1_Walking01_DDA3DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Walking01_DDA3DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Walking01_DDA3D;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Walking01_DDA3D;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Walking01_DDA3D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Walking01_DDA3D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_Walking01_DDA3D;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Walking01_DDA3D;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Walking01_DDA3D;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Walking01_DDA3D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Walking01_DDA3D;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Walking01_DDA3D;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Walking01_DDA3D;
...
void c1_Walking01_DDA3D_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Walking01_DDA3D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Walking01_DDA3D_method_dispatcher.\n"
