...
static void initialize_c2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initialize_params_c2_Walking01_DDA3D
  (SFc2_Walking01_DDA3DInstanceStruct *chartInstance);
static void enable_c2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void disable_c2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_Walking01_DDA3D
  (SFc2_Walking01_DDA3DInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Walking01_DDA3D
  (SFc2_Walking01_DDA3DInstanceStruct *chartInstance);
static void set_sim_state_c2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct *
  chartInstance, const mxArray *c2_st);
static void finalize_c2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void sf_gateway_c2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void mdl_start_c2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initSimStructsc2_Walking01_DDA3D(SFc2_Walking01_DDA3DInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c2_b_q, const char_T *c2_identifier, real_T
  c2_y[13]);
static void c2_b_emlrt_marshallIn(SFc2_Walking01_DDA3DInstanceStruct
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_realmax(SFc2_Walking01_DDA3DInstanceStruct *chartInstance);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Walking01_DDA3D, const char_T
  *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_Walking01_DDA3DInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Walking01_DDA3D = 0U;
}
  ...
  (SFc2_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Walking01_DDA3D;
  ...
  chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_Walking01_DDA3D = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_Walking01_DDA3D");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Walking01_DDA3D(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Walking01_DDA3D(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Walking01_DDA3DInstanceStruct *chartInstance;
  chartInstance = (SFc2_Walking01_DDA3DInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_Walking01_DDA3D_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Walking01_DDA3D), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Walking01_DDA3D);
  return c2_y;
}
...
void sf_c2_Walking01_DDA3D_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_Walking01_DDA3D_get_post_codegen_info(void);
mxArray *sf_c2_Walking01_DDA3D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Walking01_DDA3D_get_post_codegen_info();
...
mxArray *sf_c2_Walking01_DDA3D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Walking01_DDA3D_jit_fallback_info(void)
{
...
mxArray *sf_c2_Walking01_DDA3D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Walking01_DDA3D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"q\",},{M[8],M[0],T\"is_active_c2_Walking01_DDA3D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Walking01_DDA3D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_Walking01_DDA3DInstanceStruct *)
...
static void sf_opaque_initialize_c2_Walking01_DDA3D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
  initialize_c2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_Walking01_DDA3D(void *chartInstanceVar)
{
  enable_c2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_Walking01_DDA3D(void *chartInstanceVar)
{
  disable_c2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_gateway_c2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Walking01_DDA3D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Walking01_DDA3D(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_Walking01_DDA3D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Walking01_DDA3DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_Walking01_DDA3D((SFc2_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Walking01_DDA3D(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Walking01_DDA3D(SimStruct *S)
{
  SFc2_Walking01_DDA3DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_Walking01_DDA3DInstanceStruct *)utMalloc(sizeof
    (SFc2_Walking01_DDA3DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_Walking01_DDA3DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Walking01_DDA3D;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Walking01_DDA3D;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Walking01_DDA3D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Walking01_DDA3D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_Walking01_DDA3D;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Walking01_DDA3D;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Walking01_DDA3D;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Walking01_DDA3D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Walking01_DDA3D;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Walking01_DDA3D;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Walking01_DDA3D;
...
void c2_Walking01_DDA3D_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Walking01_DDA3D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Walking01_DDA3D_method_dispatcher.\n"
