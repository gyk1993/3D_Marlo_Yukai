...
static void initialize_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initialize_params_c3_Walking01_DDA3D
  (SFc3_Walking01_DDA3DInstanceStruct *chartInstance);
static void enable_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void disable_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_Walking01_DDA3D
  (SFc3_Walking01_DDA3DInstanceStruct *chartInstance);
static void ext_mode_exec_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c3_Walking01_DDA3D
  (SFc3_Walking01_DDA3DInstanceStruct *chartInstance);
static void set_sim_state_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct *
  chartInstance, const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_Walking01_DDA3D
  (SFc3_Walking01_DDA3DInstanceStruct *chartInstance);
static void finalize_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void sf_gateway_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void mdl_start_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void c3_chartstep_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void initSimStructsc3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static boolean_T c3_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_b_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_nargout, const char_T *c3_identifier);
static real_T c3_c_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static boolean_T c3_check_error(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_b_is_Run, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint32_T c3_g_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_b_temporalCounter_i1, const char_T
  *c3_identifier);
static uint32_T c3_h_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static const mxArray *c3_i_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_j_emlrt_marshallIn(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc3_Walking01_DDA3DInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c3_is_active_c3_Walking01_DDA3D = 0U;
  *chartInstance->c3_is_c3_Walking01_DDA3D = c3_IN_NO_ACTIVE_CHILD;
  ...
  (SFc3_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c3_is_active_c3_Walking01_DDA3D == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 2U, *chartInstance->c3_sfEvent);
  }

  if (*chartInstance->c3_is_c3_Walking01_DDA3D == c3_IN_Run) {
  ...
  if (*chartInstance->c3_is_c3_Walking01_DDA3D == c3_IN_Init) {
...
static void ext_mode_exec_c3_Walking01_DDA3D(SFc3_Walking01_DDA3DInstanceStruct *
  chartInstance)
{
  c3_update_debugger_state_c3_Walking01_DDA3D(chartInstance);
}
  ...
  (SFc3_Walking01_DDA3DInstanceStruct *chartInstance)
{
  ...
  c3_e_hoistedGlobal = *chartInstance->c3_is_active_c3_Walking01_DDA3D;
  c3_e_u = c3_e_hoistedGlobal;
  c3_f_y = NULL;
  sf_mex_assign(&c3_f_y, sf_mex_create("y", &c3_e_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 4, c3_f_y);
  c3_f_hoistedGlobal = *chartInstance->c3_is_c3_Walking01_DDA3D;
  ...
  chartInstance, const mxArray *c3_st)
{
  ...
  *chartInstance->c3_is_active_c3_Walking01_DDA3D = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 4)),
     "is_active_c3_Walking01_DDA3D");
  *chartInstance->c3_is_c3_Walking01_DDA3D = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 5)), "is_c3_Walking01_DDA3D");
...
{
  int32_T c3_i0;
  c3_set_sim_state_side_effects_c3_Walking01_DDA3D(chartInstance);
  ...
  *chartInstance->c3_sfEvent = CALL_EVENT;
  ...
  c3_chartstep_c3_Walking01_DDA3D(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c3_is_active_c3_Walking01_DDA3D == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 2U, *chartInstance->c3_sfEvent);
    *chartInstance->c3_is_active_c3_Walking01_DDA3D = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, *chartInstance->c3_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, *chartInstance->c3_sfEvent);
    *chartInstance->c3_is_c3_Walking01_DDA3D = c3_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c3_sfEvent);
    *chartInstance->c3_temporalCounter_i1 = 0U;
    ...
    *chartInstance->c3_ErrorCount = 0.0;
    ...
    switch (*chartInstance->c3_is_c3_Walking01_DDA3D) {
     case c3_IN_Init:
      CV_CHART_EVAL(2, 0, 1);
      ...
      if (c3_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c3_sfEvent);
        *chartInstance->c3_is_c3_Walking01_DDA3D = c3_IN_Run;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c3_sfEvent);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Walking01_DDA3DInstanceStruct *chartInstance;
  chartInstance = (SFc3_Walking01_DDA3DInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_Walking01_DDA3D_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_isStable = (boolean_T *)ssGetDWork_wrapper(chartInstance->S,
    1);
  chartInstance->c3_is_active_c3_Walking01_DDA3D = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
  chartInstance->c3_is_c3_Walking01_DDA3D = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 3);
...
void sf_c3_Walking01_DDA3D_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_Walking01_DDA3D_get_post_codegen_info(void);
mxArray *sf_c3_Walking01_DDA3D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_Walking01_DDA3D_get_post_codegen_info();
...
mxArray *sf_c3_Walking01_DDA3D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_Walking01_DDA3D_jit_fallback_info(void)
{
...
mxArray *sf_c3_Walking01_DDA3D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_Walking01_DDA3D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[12],T\"ErrorCount\",},{M[1],M[8],T\"q_clean\",},{M[3],M[18],T\"dq_last\",},{M[3],M[17],T\"q_last\",},{M[8],M[0],T\"is_active_c3_Walking01_DDA3D\",},{M[9],M[0],T\"is_c3_Walking01_DDA3D\",},{M[9],M[27],T\"is_Run\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[20],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Walking01_DDA3D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_Walking01_DDA3DInstanceStruct *)
...
static void sf_opaque_initialize_c3_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
  initialize_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_Walking01_DDA3D(void *chartInstanceVar)
{
  enable_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_Walking01_DDA3D(void *chartInstanceVar)
{
  disable_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_Walking01_DDA3D(void *chartInstanceVar)
{
  sf_gateway_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c3_Walking01_DDA3D(void *chartInstanceVar)
{
  ext_mode_exec_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_Walking01_DDA3D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_Walking01_DDA3D(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_Walking01_DDA3D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Walking01_DDA3DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_Walking01_DDA3D((SFc3_Walking01_DDA3DInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Walking01_DDA3D(SimStruct *S)
{
  int i;
...
mxArray *sf_c3_Walking01_DDA3D_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c3_Walking01_DDA3D(SimStruct *S)
{
...
static void mdlRTW_c3_Walking01_DDA3D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Walking01_DDA3D(SimStruct *S)
{
  SFc3_Walking01_DDA3DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_Walking01_DDA3DInstanceStruct *)utMalloc(sizeof
    (SFc3_Walking01_DDA3DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_Walking01_DDA3DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Walking01_DDA3D;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Walking01_DDA3D;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Walking01_DDA3D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_Walking01_DDA3D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_Walking01_DDA3D;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Walking01_DDA3D;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Walking01_DDA3D;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Walking01_DDA3D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Walking01_DDA3D;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Walking01_DDA3D;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Walking01_DDA3D;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c3_Walking01_DDA3D;
...
void c3_Walking01_DDA3D_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Walking01_DDA3D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Walking01_DDA3D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Walking01_DDA3D_method_dispatcher.\n"
