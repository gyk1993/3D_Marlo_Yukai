#ifndef __c65_DDA2D_OSU3Dv2_h__
#define __c65_DDA2D_OSU3Dv2_h__
...
#ifndef typedef_c65_ControlStateBus
#define typedef_c65_ControlStateBus

typedef struct ControlStateBus_tag c65_ControlStateBus;

#endif                                 /*typedef_c65_ControlStateBus*/
...
#ifndef typedef_c65_DiscreteParamsBus
#define typedef_c65_DiscreteParamsBus

typedef struct DiscreteParamsBus_tag c65_DiscreteParamsBus;

#endif                                 /*typedef_c65_DiscreteParamsBus*/
...
#ifndef typedef_c65_FeedbackParamsBus
#define typedef_c65_FeedbackParamsBus

typedef struct FeedbackParamsBus_tag c65_FeedbackParamsBus;

#endif                                 /*typedef_c65_FeedbackParamsBus*/
...
#ifndef typedef_c65_SaturationParamsBus
#define typedef_c65_SaturationParamsBus

typedef struct SaturationParamsBus_tag c65_SaturationParamsBus;

#endif                                 /*typedef_c65_SaturationParamsBus*/
...
#ifndef typedef_c65_SupervisoryParamsBus
#define typedef_c65_SupervisoryParamsBus

typedef struct SupervisoryParamsBus_tag c65_SupervisoryParamsBus;

#endif                                 /*typedef_c65_SupervisoryParamsBus*/
...
#ifndef typedef_c65_ThetaParamsBus
#define typedef_c65_ThetaParamsBus

typedef struct ThetaParamsBus_tag c65_ThetaParamsBus;

#endif                                 /*typedef_c65_ThetaParamsBus*/
...
#ifndef typedef_c65_PhiParamsBus
#define typedef_c65_PhiParamsBus

typedef struct PhiParamsBus_tag c65_PhiParamsBus;

#endif                                 /*typedef_c65_PhiParamsBus*/
...
#ifndef typedef_c65_OutputParamsBus
#define typedef_c65_OutputParamsBus

typedef struct OutputParamsBus_tag c65_OutputParamsBus;

#endif                                 /*typedef_c65_OutputParamsBus*/
...
{
  c65_SupervisoryParamsBus Supervisory;
  c65_DiscreteParamsBus Discrete;
  c65_OutputParamsBus Output;
  c65_FeedbackParamsBus Feedback;
  c65_SaturationParamsBus Saturation;
};

#endif                                 /*struct_ControlParamsBus_tag*/

#ifndef typedef_c65_ControlParamsBus
#define typedef_c65_ControlParamsBus

typedef struct ControlParamsBus_tag c65_ControlParamsBus;

#endif                                 /*typedef_c65_ControlParamsBus*/

#ifndef typedef_SFc65_DDA2D_OSU3Dv2InstanceStruct
#define typedef_SFc65_DDA2D_OSU3Dv2InstanceStruct
...
typedef struct {
  ...
  uint8_T c65_is_active_c65_DDA2D_OSU3Dv2;
  real_T (*c65_TorqueSaturationLimits)[2];
  real_T (*c65_y)[6];
  real_T (*c65_dy)[6];
  real_T *c65_s;
  boolean_T *c65_Error;
  c65_ControlStateBus *c65_ControlState;
  c65_ControlParamsBus *c65_ControlParams;
  real_T *c65_ErrorCount;
  real_T *c65_ErrorCountIn;
} SFc65_DDA2D_OSU3Dv2InstanceStruct;

#endif                                 /*typedef_SFc65_DDA2D_OSU3Dv2InstanceStruct*/
...
extern const mxArray *sf_c65_DDA2D_OSU3Dv2_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c65_DDA2D_OSU3Dv2_get_check_sum(mxArray *plhs[]);
extern void c65_DDA2D_OSU3Dv2_method_dispatcher(SimStruct *S, int_T method, void
  *data);
