...
MODEL           = Walking_ATRIAS
MODULES         = Walking_ATRIAS_capi.c Walking_ATRIAS_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = Walking_ATRIAS.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\xingye\Documents\SVN\MARLO_Controllers\DAQ\Safety
S_FUNCTIONS     = xpcethercatpdorx.c xpcethercatpdotx.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = Walking_ATRIASlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Walking_ATRIAS_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Walking_ATRIAS_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\xingye\Documents\SVN\MARLO_Controllers\TransitionExp
