...
MODEL           = Walking01_withElmos
MODULES         = Walking01_withElmos_capi.c Walking01_withElmos_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = Walking01_withElmos.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\rosshart\Desktop\SVN\MARLO_3D_Controllers\DAQ_withElmos\Safety
S_FUNCTIONS     = xpcsetoverload.c fiforeadbinhdrmultiple.c board_setup_tews_XR17D15x.c setup_tews_XR17D15x.c read_hw_fifo_XR17D15x.c fifowrite.c xpcethercatpdorx.c xpctimeinfo.c xpcgetoverload.c xpcethercatpdotx.c
S_FUNCTIONS_LIB = 
NUMST           = 3
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = Walking01_withElmoslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Walking01_withElmos_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Walking01_withElmos_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\rosshart\Desktop\SVN\MARLO_3D_Controllers\Walking\InPlace\Rocking\DynamicModel\c
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\rosshart\Desktop\SVN\MARLO_3D_Controllers\Walking\InPlace\Rocking
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\serial\include
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{C:\Users\rosshart\Desktop\SVN\MARLO_3D_Controllers\DAQ_withElmos\R2014b\xpcblocks}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\serial}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
...
{C:\Users\rosshart\Desktop\SVN\MARLO_3D_Controllers\DAQ_withElmos\R2014b\xpcblocks}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\serial}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
