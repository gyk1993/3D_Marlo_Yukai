...
% Back toe
f_name_1 = 'J_holConstrVelocity_toebottomleftback';
tmp1 = feval(f_name_1,[q,dq]);
f_name_2 = 'Js_holConstrVelocity_toebottomleftback';
...
% Front toe
f_name_1 = 'J_holConstrVelocity_toebottomleftfront';
tmp1 = feval(f_name_1,[q,dq]);
f_name_2 = 'Js_holConstrVelocity_toebottomleftfront';
tmp2 = feval(f_name_2,0);
% Construct Jacobian
J4 = zeros(nFe4,2*DOF);
for i = 1:size(tmp2,1)
