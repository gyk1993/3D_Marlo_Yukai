...
% Back toe
f_name = 'J_holConstrImpactForce_toebottomrightback';
tmp1 = feval(f_name,[q,Fimp3]);
f_name = 'Js_holConstrImpactForce_toebottomrightback';
tmp2 = feval(f_name,0);
...
f_name = 'J_holConstrVelocity_toebottomrightback';
tmp1 = feval(f_name,[q,dq_end]);
f_name = 'Js_holConstrVelocity_toebottomrightback';
tmp2 = feval(f_name,0);
...
% Front toe
f_name = 'J_holConstrImpactForce_toebottomrightfront';
tmp1 = feval(f_name,[q,Fimp4]);
f_name = 'Js_holConstrImpactForce_toebottomrightfront';
tmp2 = feval(f_name,0);
...
f_name = 'J_holConstrVelocity_toebottomrightfront';
tmp1 = feval(f_name,[q,dq_end]);
f_name = 'Js_holConstrVelocity_toebottomrightfront';
tmp2 = feval(f_name,0);
