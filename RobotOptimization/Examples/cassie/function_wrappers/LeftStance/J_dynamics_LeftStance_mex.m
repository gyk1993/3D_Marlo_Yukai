function [ output ] = J_dynamics_LeftStance_mex( vars )
...
f_name = 'J_holConstrExternalForce_toebottomleftback';
tmp1 = feval(f_name,[q,Fe3]);
f_name = 'Js_holConstrExternalForce_toebottomleftback';
tmp2 = feval(f_name,0);
% Construct Jacobian
...
f_name = 'J_holConstrExternalForce_toebottomleftfront';
tmp1 = feval(f_name,[q,Fe4]);
f_name = 'Js_holConstrExternalForce_toebottomleftfront';
tmp2 = feval(f_name,0);
% Construct Jacobian
