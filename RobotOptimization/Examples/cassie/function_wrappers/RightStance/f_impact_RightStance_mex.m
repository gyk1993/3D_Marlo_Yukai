...
% Back toe
f_name = 'f_holConstrImpactForce_toebottomleftback';
Force3 = feval(f_name,[q,Fimp3]);
f_name = 'f_holConstrVelocity_toebottomleftback';
velConstr3 = feval(f_name,[q,dq_end]);

% Front toe
f_name = 'f_holConstrImpactForce_toebottomleftfront';
Force4 = feval(f_name,[q,Fimp4]);
f_name = 'f_holConstrVelocity_toebottomleftfront';
