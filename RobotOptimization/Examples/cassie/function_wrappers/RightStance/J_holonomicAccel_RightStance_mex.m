...
% Back toe
f_name_1 = 'J_holConstrAcceleration_toebottomrightback';
tmp1 = feval(f_name_1,[q,dq,ddq]);
f_name_2 = 'Js_holConstrAcceleration_toebottomrightback';
...
% Front toe
f_name_1 = 'J_holConstrAcceleration_toebottomrightfront';
tmp1 = feval(f_name_1,[q,dq,ddq]);
f_name_2 = 'Js_holConstrAcceleration_toebottomrightfront';
tmp2 = feval(f_name_2,0);
% Construct Jacobian
J4 = zeros(nFe4,3*DOF);
for i = 1:size(tmp2,1)
