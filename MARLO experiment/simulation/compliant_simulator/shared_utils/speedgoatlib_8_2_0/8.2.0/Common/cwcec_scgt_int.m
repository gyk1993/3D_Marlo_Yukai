...
board.name = 'SCRAMNet_GT200';
board.VendorId = hex2dec('1387');
board.DeviceId = hex2dec('5310');
board.SubVendorId = -1;
board.SubDeviceId = -1;
board.PreHookFunction = 'xpcscgtprehook';
board.PostHookFunction = 'NULL';
board.HookIncludeFile = 'cwcec_scgthooks';
board.StartFunction = 'xpcscgtstart';
board.StopFunction = 'xpcscgtstop';
