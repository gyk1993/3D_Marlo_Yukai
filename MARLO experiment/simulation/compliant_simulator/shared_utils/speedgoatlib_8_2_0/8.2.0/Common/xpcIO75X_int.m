...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO75X';
 board.VendorId = hex2dec('15cf'); 
 board.DeviceId = hex2dec('0000'); 
 board.SubVendorId = hex2dec('0000');
 board.SubDeviceId = hex2dec('000');                      
 board.PreHookFunction = 'xpcIO75Xprehook';
 board.PostHookFunction =  'NULL';  
 board.HookIncludeFile = 'xpcIO75Xhooks';
 board.StartFunction = 'xpcIO75Xstart';
 board.StopFunction = 'xpcIO75Xstop';
