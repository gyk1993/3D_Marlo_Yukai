function board = xpcIO314_inta_int
...
%  you will get an error and the entry in the list won't work.
 ...
 board.name = 'Speedgoat IO314 IntA';
 board.VendorId = hex2dec('16d5'); 
 board.DeviceId = hex2dec('2004'); 
 board.SubVendorId = hex2dec('16d5');
 board.SubDeviceId = hex2dec('2004');
 board.PreHookFunction = 'xpcIO314intaprehook';
 board.PostHookFunction =  'NULL'; %'xpcdx2004intaposthook'
 board.HookIncludeFile = 'xpcIO314intahooks';
 board.StartFunction = 'xpcIO314intastart';
 board.StopFunction = 'xpcIO314intastop';
